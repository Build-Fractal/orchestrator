...
- `scripts/dispatch/build-context.sh` exists and is functional (from M001 + M005 refactoring). It has two branches: a planning-payload branch (`_bc_assemble_planning_payload`) and a recipe-driven task-dispatch branch.
