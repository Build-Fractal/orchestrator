...
# Dispatch Context -- T03 (Phase P03, Milestone M008)
## Manifest
...
| Task Plan | 696-1007 | ~2800 | required |
...
The wrapper forwards arguments through transparently — whatever the caller passes after `--` flows to each invoked script unchanged. Individual knowledge scripts remain the source of truth for their own behavior (M007 pipeline is untouched).
