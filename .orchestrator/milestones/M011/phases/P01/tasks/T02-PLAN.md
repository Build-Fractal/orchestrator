...
This only matches files one level deep (e.g., `knowledge/patterns/MEM001.md`). It does not match files two levels deep (e.g., `knowledge/spec/requirement/SPEC-FR-001.md`).
