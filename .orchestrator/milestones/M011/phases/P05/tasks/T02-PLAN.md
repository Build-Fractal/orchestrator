...
- `scripts/knowledge/traverse-graph.sh` accepts `--id <id> --hops 1` and emits neighbor IDs on stdout. Established by M007; extended by P04 for spec-category respect.
