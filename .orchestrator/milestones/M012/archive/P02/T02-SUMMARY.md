...
- Section indexes: all four (`knowledge/index.md`, `knowledge/patterns/index.md`, `knowledge/conventions/index.md`, `knowledge/lessons/index.md`) exist and carry the `Auto-generated section index` probe comment.
...
- **.orchestrator/milestones/M012/phases/P02/D011-EVALUATION.md** — T05 records the D011 mechanical-evaluation outcome.
