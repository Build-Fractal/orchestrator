...
9. `m012-p02-d011-evaluation.sh` — asserts `.orchestrator/milestones/M012/phases/P02/D011-EVALUATION.md` exists with the required frontmatter + body shape + "M020 promoted" conclusion.
...
1. **Create `.orchestrator/milestones/M012/phases/P02/D011-EVALUATION.md`** — the structured record. Body shape:
   ...
   Per `.orchestrator/DECISIONS.md` D011 and `.orchestrator/milestones/M012/M012-CONTEXT.md`
   ...
   **1 of 3 criteria shipped → M020 is PROMOTED** per D011's trigger rule
   ...
   Post-M012 the roadmap is updated to position M020 between M014 and M019
   Tier 2/3, per D011's framing (see `.orchestrator/DECISIONS.md` D011 for the
   ...
   - `.orchestrator/DECISIONS.md` — D011 (trigger rule + criteria definitions).
   - `.orchestrator/milestones/M012/M012-CONTEXT.md` — AD-1 (criteria selection rationale).
   - `.orchestrator/milestones/M012/M012-ROADMAP.md` — cross-cutting-concern bullet committing this evaluation to P02.
...
- `.orchestrator/milestones/M012/phases/P02/D011-EVALUATION.md` exists, ≥ 30 lines, contains "M020 promoted", frontmatter has `decision: D011` and `milestone: M012`, body enumerates all three criteria and cites DECISIONS.md + M012-CONTEXT.md.
...
- `.orchestrator/DECISIONS.md` — D011 content (cited by the D011-EVALUATION.md record).
- `.orchestrator/milestones/M012/M012-CONTEXT.md` — AD-1 (cited by the D011-EVALUATION.md record).
- `.orchestrator/milestones/M012/M012-ROADMAP.md` — cross-cutting-concern bullet committing the D011 evaluation to P02 close.
...
2. `.orchestrator/milestones/M012/phases/P02/D011-EVALUATION.md` exists, structured as documented, ≥ 30 lines.
