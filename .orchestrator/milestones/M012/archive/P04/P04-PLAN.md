...
- `.orchestrator/milestones/M012/phases/P04/DEPLOY-RECORD.md` (min 25 lines, contains "gh-pages") — first-deploy record with YAML frontmatter + gate-result fields.
...
- `.orchestrator/milestones/M012/phases/P04/DEPLOY-RECORD.md` → `wiki-deploy.sh` (record references the wrapper)
