...
- **Knowledge-Layer Boundary (FR-9 + D014)**: this task MUST NOT modify any `knowledge/spec/**/SPEC-*.md` frontmatter. It MUST NOT add review-state lifecycle, query-surface, or clustering primitives. M020 owns schema extension.
...
- **No schema changes to M011/M012 artifacts**: do not touch `KNOWLEDGE-INDEX.md`, `knowledge/spec/`, `scripts/knowledge/rebuild-index.sh`, or any `wiki/` file.
