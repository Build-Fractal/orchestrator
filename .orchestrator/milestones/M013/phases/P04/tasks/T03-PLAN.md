...
- M019 Tier 1 JSONL shape for `unit_close`: record is `{"ts":"<ISO>","event":"unit_close","source":"runtime","milestone":"<M###>","phase":"<P##>","task":"<T##>|null","oid":"<orchestrator-id>","issue_number":<int>,"outcome":"closed|status-synced"}`.
