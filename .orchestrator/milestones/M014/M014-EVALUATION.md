...
- **Load-bearing dogfood**: P1 (US-2 `orchestrator:specify`) is the authoring surface every subsequent orchestrator-authored spec consumes; P1 exit criteria gate M013→M024→M020 future-spec authorship (SC-13). Cross-milestone dependency.
