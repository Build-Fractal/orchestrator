...
- `.orchestrator/milestones/M014/phases/P02/WRITE-SITES.md` (min 30 lines, contains "project-identity") — the enumerated call-site manifest
...
- `.orchestrator/milestones/M014/phases/P02/WRITE-SITES.md` (create)
