...
Produce the canonical write-site manifest for P02 at `.orchestrator/milestones/M014/phases/P02/WRITE-SITES.md` and ship a scan verifier that confirms no write-site exists outside the enumerated set.
...
### Step 1: Create `.orchestrator/milestones/M014/phases/P02/WRITE-SITES.md`
...
- `.orchestrator/milestones/M014/phases/P02/WRITE-SITES.md` exists, names both regions (`project-identity`, `recent-changes`), enumerates exactly four write-site rows (specify, init-project, reinit-handler, consolidate-artifacts)
...
1. `.orchestrator/milestones/M014/phases/P02/WRITE-SITES.md` — write-site manifest (~110 lines)
