...
- T01 has shipped the write-site manifest at `.orchestrator/milestones/M014/phases/P02/WRITE-SITES.md` naming `scripts/lifecycle/init-project.sh` and `scripts/lifecycle/reinit-handler.sh` as `project-identity` region call sites.
...
- `.orchestrator/milestones/M014/phases/P02/WRITE-SITES.md` (from T01) — source of truth naming both sites as `project-identity` writers.
