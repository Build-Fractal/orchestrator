...
# Dispatch Context -- T02-classify (Phase P03, Milestone M014)
## Manifest
...
| Task Plan | 1009-1357 | ~4500 | required |
| State Context | 1359-1365 | ~100 | required |
| First-Turn Completeness | 1367-1418 | ~800 | required |
| **Total** | | **~19500** | |
...
2. The four-class regex/heuristic v1 ruleset (D023 pin). All rules operate on the comment body text:
   ...
   - **`uat-bug`**: body matches any of these patterns (case-insensitive):
     ...
     - YAML frontmatter shape installed by M013's UAT Bug template (line containing `kind:\s*uat-bug` near the top of the body)
...
- `.orchestrator/DECISIONS.md` D023 — pin rationale + retune trigger.
