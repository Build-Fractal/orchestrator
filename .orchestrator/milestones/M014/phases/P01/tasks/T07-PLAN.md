...
- `scripts/verify/run-suite.sh` — M016 wrapper pattern for running a phase-level test suite.
- `tests/fixtures/m021-prompt-corpus.txt` — M021 prompt-corpus fixture used for zero-prompts attestation.
