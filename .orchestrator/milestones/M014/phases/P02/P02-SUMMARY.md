...
**Write-site enumeration** (T01 → `.orchestrator/milestones/M014/phases/P02/WRITE-SITES.md`):
...
- `scripts/diagnostics/check-docs.sh` gained a `--check drift` mode (default `--check docs` preserves M006 behavior).
...
- P03 stays deferred (blocked on M012 DEPLOY-RECORD resolution + ≥1 week inbox dogfood data per D018). P04 is next.
