...
6. **Write manifest** to `.orchestrator/specify/decomposition/<source-id>/manifest.md` (interim path per FR-7 + D016; M024 will migrate to `.orchestrator/intake/<id>/decomposition.md`).
