...
3. Remove the now-empty `.specify/memory/` directory. It should contain no other files at this point (M008 moved the constitution as the only file under `.specify/memory/`; no subdirectories or other files exist):
