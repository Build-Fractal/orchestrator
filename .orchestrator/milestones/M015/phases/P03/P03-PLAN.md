...
- CHANGELOG.md has a new M015 entry at the top of the file (under the file's top-level heading and above the prior top entry). The entry describes the standalone cutover. Historical entries for M001–M008 remain byte-identical to their state before P03 began.
...
- .orchestrator/milestones/M015/phases/P03/P03-PLAN.md → specs/015-standalone-cutover/spec.md
...
See .orchestrator/milestones/M015/phases/P03/tasks/T01-PLAN.md.

### T02: Reframe the five primary standalone docs + append CHANGELOG M015 entry

See .orchestrator/milestones/M015/phases/P03/tasks/T02-PLAN.md.

### T03: Sweep wider reference/user-guide docs + write migration guide

See .orchestrator/milestones/M015/phases/P03/tasks/T03-PLAN.md.

### T04: Tighten ALLOW_P03_DOCS allow-list and run full P03 verify suite

See .orchestrator/milestones/M015/phases/P03/tasks/T04-PLAN.md.
