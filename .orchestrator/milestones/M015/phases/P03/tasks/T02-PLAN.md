...
3. **Rewrite `CLAUDE.md`** (currently 78 lines). This file is the project instruction document for Claude Code operating IN this repo.
   ...
   - Rewrite "Key Files": remove `extension.yml`; update `.specify/memory/constitution.md` to `.orchestrator/memory/constitution.md`; update `.specify/orchestrator/KNOWLEDGE.md` to `.orchestrator/KNOWLEDGE.md`; update `.specify/orchestrator/milestone-summary.md` to `.orchestrator/milestone-summary.md`.
   ...
   - Recent Changes: add an M015 line at the top. Keep the M008 and M001/M006 lines.
...
- `.orchestrator/milestones/M008/M008-SUMMARY.md` (if it exists) — source of truth for the runtime list (Claude Code / Codex CLI / Cursor) and standalone capability description.
