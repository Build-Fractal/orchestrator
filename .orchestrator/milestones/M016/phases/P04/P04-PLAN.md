...
- .orchestrator/milestones/M016/phases/P04/evidence/zero-prompts-attestation.md (min 20 lines, contains "prompt_count: 0")

### Key Links

- .claude/settings.json -> ANTIPATTERNS.md (settings covers Class B gaps documented in catalog)
- .orchestrator/milestones/M016/phases/P04/evidence/zero-prompts-attestation.md -> .claude/settings.json (attestation references the promoted settings)
...
- .orchestrator/milestones/M016/phases/P04/evidence/zero-prompts-attestation.md (create)
