...
Create `.orchestrator/milestones/M018/phases/P03/P03-SUMMARY.md` per `templates/phase-summary.md`. The 16-field frontmatter (per MEM013) plus a closure body. Sample shape:
...
- `.orchestrator/milestones/M018/phases/P03/P03-SUMMARY.md` exists, ≥ 40 lines, contains `tier1_savings_tokens`.
