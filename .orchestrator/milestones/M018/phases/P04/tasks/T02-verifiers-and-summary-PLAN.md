...
### Step 11 — Author `.orchestrator/milestones/M018/phases/P04/P04-SUMMARY.md`
...
- P04-SUMMARY.md exists at `.orchestrator/milestones/M018/phases/P04/P04-SUMMARY.md` with the frontmatter named in Step 11 and a body documenting closure summary, risk-mitigation traceability, follow-ups for downstream phases, and verification result.
...
- `.orchestrator/milestones/M018/phases/P04/P04-SUMMARY.md` exists, ~80–150 lines, contains "tier2_savings_tokens".
