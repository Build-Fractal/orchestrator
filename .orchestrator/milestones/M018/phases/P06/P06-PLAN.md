...
- `.orchestrator/milestones/M018/phases/P06/P06-SUMMARY.md` (min 50 lines, contains "tier3")
...
See `.orchestrator/milestones/M018/phases/P06/tasks/T01-tier3-helper-PLAN.md`.
...
See `.orchestrator/milestones/M018/phases/P06/tasks/T02-schema-extensions-PLAN.md`.

### T03: compression-eval.sh `--tier 3` real cohort logic replaces P05 stub

See `.orchestrator/milestones/M018/phases/P06/tasks/T03-compression-eval-tier3-PLAN.md`.

### T04: Verifiers + fixtures + helper + P06-SUMMARY (via phase-transition.sh --write) + dual-write

See `.orchestrator/milestones/M018/phases/P06/tasks/T04-verifiers-and-summary-PLAN.md`.
...
- .orchestrator/milestones/M018/phases/P06/P06-SUMMARY.md (create).
