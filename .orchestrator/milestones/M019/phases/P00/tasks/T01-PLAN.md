...
- `.orchestrator/milestones/M019/M019-ROADMAP.md` — roadmap describing P00 Boundary Map produces set.
- `.orchestrator/milestones/M019/M019-CONTEXT.md` — design constraints + AD-1..AD-8 definitions.
...
- `.orchestrator/milestones/M019/M019-CONTEXT.md` — AD-1..AD-8 definitions.
...
- **No compound bash in agent-facing content** (Constitution XV + M021 hook). Verify-script internals may use `$()`, pipes, subshells (MEM004 + AP-004 carve-out). Truth `Check:` commands in this plan and the phase plan are single-script-file shape (AD-19).
