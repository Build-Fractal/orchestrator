...
T01 has landed: `knowledge/conventions/MEM031.md` exists and documents the
...
- `knowledge/conventions/MEM031.md` (from T01)
...
- `knowledge/patterns/MEM001.md` — example pre-M020 entry with no `status:` field; smoke-test target for FR-10 default behavior.
