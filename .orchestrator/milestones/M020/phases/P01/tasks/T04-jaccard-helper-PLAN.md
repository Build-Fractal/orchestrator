...
- `validate` subcommand creates the report at `.orchestrator/milestones/M020/phases/P01/jaccard-validation-report.md` and writes the configuration header + the iteration loop output (T05 will enrich with threshold recommendation).
...
- `knowledge/conventions/MEM031.md` (T01) — informational; cited in the
...
3. `bash scripts/knowledge/lib/jaccard.sh validate knowledge/` writes a stub report at `.orchestrator/milestones/M020/phases/P01/jaccard-validation-report.md` (T05 will enrich the recommendation section).
