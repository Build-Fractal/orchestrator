...
- **Future schema evolutions** must update three locations in lockstep: `.orchestrator/DECISIONS.md` (new D-row), `knowledge/conventions/MEM031.md` (vocabulary append), and `scripts/verify/knowledge-schema-lint.sh` (allowlist append). The lint is the executable enforcement of the prose contract.
