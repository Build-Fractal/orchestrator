...
- `scripts/util/README.md` — catalog index with one-line usage examples for each wrapper, M011 screenshot replacement notes, exit codes, and composition patterns. README-catalog gate enforces structure.
