...
The ten-pattern matrix is closed on AD-2 (see `.orchestrator/milestones/M021/M021-CONTEXT.md`). Six rewrites, four rejects. This task authors exactly one test case per matrix entry — no speculative additions (constitution XIV).
