...
- `.orchestrator/milestones/M021/phases/P01/P01-SUMMARY.md`, `P02/P02-SUMMARY.md`, `P03/P03-SUMMARY.md` — closed-phase summaries. Each must have YAML-frontmatter line matching `^verification_result: *"?pass"?`.
- `.orchestrator/milestones/M021/phases/P04/P04-SUMMARY.md` — may or may not exist when this gate runs (self-referential). Missing is acceptable; present-but-not-pass is not.
