...
- T04 → `.orchestrator/DECISIONS.md` with D012 row appended; `ANTIPATTERNS.md` with Cross-Refs blocks on AP-005..AP-009.
...
- `.orchestrator/DECISIONS.md` modified by T04.a — asserted by decisions-d012 gate.
