...
5. **Write the authoritative matrix** to `.orchestrator/milestones/M026/M026-CONVERSUS-PARITY.md`. Required structure:
...
- `.orchestrator/milestones/M026/M026-CONVERSUS-PARITY.md` — authoritative artifact (80+ lines).
- `.orchestrator/milestones/M026/phases/P01/P01-CONVERSUS-PARITY-MATRIX.md` — phase-local pointer (5-10 lines).
