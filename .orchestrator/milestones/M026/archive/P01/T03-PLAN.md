...
3. **Author `OLLAMA-PROBE.md`** at `.orchestrator/milestones/M026/phases/P01/OLLAMA-PROBE.md`:
...
- `.orchestrator/milestones/M026/M026-CONTEXT.md` OQ-3 + OQ-5 sections (read for rationale).
...
- `.orchestrator/milestones/M026/phases/P01/OLLAMA-PROBE.md` — probe report (15+ lines) with ollama block + pipx block + P02 fallback posture section.
