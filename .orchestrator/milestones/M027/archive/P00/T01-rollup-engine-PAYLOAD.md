...
# Dispatch Context -- T01-rollup-engine (Phase P00, Milestone M027)
## Manifest
...
| Task Plan | 985-1118 | ~3200 | required |
| State Context | 1120-1126 | ~100 | required |
| First-Turn Completeness | 1128-1177 | ~900 | required |
| **Total** | | **~15600** | |
...
- The repo's `.orchestrator/milestones/M019/execution-log.jsonl` already contains M019 Tier 1 records emitted under the schema enforced by `scripts/verify/m019-schema.sh`. M019 Tier 1 closed 2026-04-18.
...
- `bash scripts/diagnostics/metrics-rollup.sh --granularity milestone --milestone M019` — should exit 0 and print one paired row to stdout.
- The remaining contract verifiers (Goodhart pairing, source-filter, aggregation precedence, corrupt-line, FS-race, perf bound, etc.) live in T03 and are wired into `scripts/verify/m027-rollup-schema.sh` in T04.
...
- M019 P01 SUMMARY at `.orchestrator/milestones/M019/phases/P01/P01-SUMMARY.md` — reference for record schema field names. Not read at runtime.
