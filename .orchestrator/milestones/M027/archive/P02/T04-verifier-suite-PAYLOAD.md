...
# Dispatch Context -- T04-verifier-suite (Phase P02, Milestone M027)
## Manifest
...
| Task Plan | 1029-1284 | ~5900 | required |
| State Context | 1286-1292 | ~100 | required |
| First-Turn Completeness | 1294-1339 | ~900 | required |
| **Total** | | **~23600** | |
...
3. **`m027-p02-efficiency-footer-shape.sh`** (~60 lines) — gates Truth #1:
   ...
   - Run `bash scripts/diagnostics/efficiency-footer.sh --milestone M019` and capture exit code; assert exit 0 (smoke-test that helper does not crash on a real milestone).
   - PASS.
