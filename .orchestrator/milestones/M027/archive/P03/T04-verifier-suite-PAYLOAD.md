...
# Dispatch Context -- T04-verifier-suite (Phase P03, Milestone M027)
## Manifest
...
| Task Plan | 1089-1357 | ~6500 | required |
| State Context | 1359-1365 | ~100 | required |
| First-Turn Completeness | 1367-1417 | ~1000 | required |
| **Total** | | **~29700** | |
...
7. `m027-p03-anomaly-latency.sh` — gates Truth #7 (latency budget; inner-vs-outer split against M013).
...
3. **`m027-p03-anomaly-shape.sh`** (~70 lines) — gates Truth #1:
   ...
   - Run `bash scripts/diagnostics/check-anomalies.sh --milestone M021 --sample-floor 5` and assert stdout contains `insufficient sample`.
   - PASS.
