...
- `.orchestrator/milestones/M028/phases/P01/classifier-audit.md` (min 30 lines, contains "AP-009")
...
- `.orchestrator/milestones/M028/phases/P01/P01-VERIFICATION.md` → `.orchestrator/milestones/M028/phases/P01/classifier-audit.md` (verification document cites the audit)
...
- `.orchestrator/milestones/M028/phases/P01/classifier-audit.md` (create)
