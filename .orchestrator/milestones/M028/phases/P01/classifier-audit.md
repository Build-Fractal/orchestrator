...
- **Cited at**: `specs/031-autonomous-hardening-v3/spec.md:24` (problem-statement bullet 1, second half) and `.orchestrator/proposals/M028-autonomous-hardening-v3.md:79-100` (Finding F section)
...
- **Cited at**: `specs/031-autonomous-hardening-v3/spec.md:69` (US-2 acceptance scenario 1) and `.orchestrator/proposals/M028-autonomous-hardening-v3.md:104-124` (Finding G section)
