...
- `bash tests/run-prompt-corpus-replay.sh` exits 0 with `WOULD_PROMPT=0/27` final line — the combined M021 + M028 corpus replays clean under the current classifier (strict-superset CON-7 preserved). Satisfies SC-1 + SC-8.
