...
4. **Author `tools/verify/m029-p01-scope-guard.sh`** (≥50 lines, executable). The verifier:
   ...
   - Defines the denylist (files explicitly out of P01 claim):
     ...
     - `.orchestrator/KNOWLEDGE.md` — M020 owned
     - `.orchestrator/integrations/github.json` — M013 owned
...
- A summary file at `.orchestrator/milestones/M029/phases/P01/tasks/T06-acceptance-and-phase-suite-SUMMARY.md` documents the deliverables.
