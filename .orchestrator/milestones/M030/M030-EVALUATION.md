...
- **Sequencing assumption**: M028 (autonomous hardening v3) must close before M030 — M028 stabilizes autonomous runs whose JSONL feeds the shadow corpus.
