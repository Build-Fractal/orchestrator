...
- `.orchestrator/milestones/M030/M030-CONTEXT.md` → `tests/fixtures/m030-classifier-corpus/README.md` (D-A4 independence constraint originates the README's compliance section)
