...
1. **Author `tests/fixtures/m030-classifier-corpus/README.md`.** Required structure:
   ...
   **the labels were applied before the classifier was authored**.
   ...
   M001 through M027. In-flight milestones (M028, M030 itself) are
   ...
   Per `.orchestrator/milestones/M030/M030-CONTEXT.md` D-A4 (and
   ...
   - `.orchestrator/milestones/M030/M030-CONTEXT.md` D-A4
...
- `.orchestrator/milestones/M030/M030-CONTEXT.md` lines 38-42 (D-A4; verbatim source for the README's `## D-A4 Independence Compliance` section).
