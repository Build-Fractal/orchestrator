...
- `references/model-routing.md ## Operator Overrides` — operator-facing surface consumed by M030/P05 `orchestrator:doctor --config-check` and by M035 install-bundle distribution
