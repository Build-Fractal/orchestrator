...
- .orchestrator/milestones/M030/M030-CONTEXT.md → scripts/dispatch/dispatch-interface.sh (D-A2 names dispatch-interface as the programmatic enforcement point; D-A3 names per-class partial-flip authorization)
