...
- `scripts/util/dual-write-runtime-md.sh` exists (M014/M021 deliverable; per CLAUDE.md "recent-changes" convention).
...
- `AGENTS.md` exists at repo root (M014 dual-write target).
...
6. **Stage all P05 deliverables.** Stage:
   ...
   - `.orchestrator/milestones/M030/phases/P05/P05-PLAN.md` + `tasks/T0[1-3]-*-PLAN.md` (the plan files this task plan was authored from)
