...
- The forward roadmap at `CLAUDE.md` is in its post-M028 / post-P05 form. T03 appends a single-line P06-close fragment via dual-write.
...
T03 also authors `.orchestrator/milestones/M030/phases/P06/P06-SUMMARY.md` per the schema established by P02-P05 summaries. Frontmatter shape:
...
5. **Author `.orchestrator/milestones/M030/phases/P06/P06-SUMMARY.md`** per the schema in the Description. Use the P05-SUMMARY.md as the structural template (frontmatter + body sections).
...
- **Project-owned-verifier-paths discipline (M032 Finding A)**: phase-suite aggregator lives under `tools/verify/` with slug-bearing filename `p06-phase-suite.sh`.
...
- `.orchestrator/milestones/M030/phases/P06/P06-SUMMARY.md` — phase-summary file per the schema in the Description.
...
- `git log --oneline -3` (post-T03) →
  ...
  <SHA> docs: M028 close ack + M030 in-progress audit + fold in M036 capture
