...
- `specs/034-right-sized-entry/spec.md` → `.orchestrator/milestones/M031/M031-CONTEXT.md` (folded AD bodies preserve their CONTEXT.md provenance via inline citation; the audit trail allows future readers to trace AD-N to the originating context-draft block)
