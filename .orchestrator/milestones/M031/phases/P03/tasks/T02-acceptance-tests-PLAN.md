...
- **Real-app smoke test pending** (plan-time discipline rule 5): T02 verifies SC-7 / SC-8 via the `--dispatch-stub` test seam. Production behavior with the live agent runtime adapter (MEM018) is exercised only in integration with M033 onboarding flows; SC-7 / SC-8 + their shape verifiers gate the contract surface, not the production runtime end-to-end.
