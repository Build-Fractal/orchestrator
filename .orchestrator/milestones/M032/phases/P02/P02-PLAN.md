...
- `tools/verify/m032-p02-mkdocs-templating-and-self-application.sh` (min 30 lines, contains "{{site_name}}", contains "{{repo_url}}", contains "FR-6", contains "MIT-002", contains "spec-kit-orchestrator") — create
