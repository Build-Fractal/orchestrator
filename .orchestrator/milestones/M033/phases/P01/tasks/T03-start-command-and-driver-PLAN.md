...
- `scripts/lifecycle/init-project.sh` exists (M001/M015 closed) and accepts `--project-dir <path>` per existing contract — verified by `[ -f scripts/lifecycle/init-project.sh ]`.
...
- A summary file at `.orchestrator/milestones/M033/phases/P01/tasks/T03-start-command-and-driver-SUMMARY.md` documents the deliverables and references the SC-1 acceptance assertions T05 will exercise against this skeleton.
