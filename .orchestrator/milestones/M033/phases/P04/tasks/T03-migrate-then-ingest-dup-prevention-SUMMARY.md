...
- bash scripts/diagnostics/check-plans.sh: rc=0 (advisory check per MEM015/MEM006; warnings are all pre-existing M002-M005 historical plans, none about M033 or T03)
