...
- `tools/verify/m033-p05-scope-guard.sh` -- bidirectional forbidden-presence + allowed-presence + M020 schema-overreach negative-grep. Emits `SUMMARY: pass=30 fail=0`.
