...
the `speckit-` prefix per D-RN-1 (npm package name
...
path); `.orchestrator/milestones/M008/archive/P05/T06-PAYLOAD.md` +
`T06-PLAN.md` (archived milestone artifacts); `.orchestrator/
milestones/M015/phases/P04/evidence/clean-clone-shape.txt` (M015
clean-clone evidence — a path snapshot at the time the milestone
closed; rewriting would falsify the audit trail);
`.orchestrator/milestones/M035/M035-ROADMAP.md` (narrative documenting
