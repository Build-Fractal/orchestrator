...
`.orchestrator/DECISIONS.md`, `.orchestrator/proposals/`,
`.orchestrator/KNOWLEDGE.md`, archived milestone summaries among
...
the C6 grep — closed-milestone authoring artifacts (M018, M020, M024,
M028, M030, M031, M032, M033, M036, M037 plan/payload/summary files)
