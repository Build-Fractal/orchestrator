...
papercut-sweep-pre-M030.md (historical paper-cut log); .orchestrator/
...
CHANGELOG.md (version history headers); .orchestrator/DECISIONS.md
...
verbatim post-rename); .orchestrator/KNOWLEDGE.md (consolidated knowledge
...
.orchestrator/milestones/M035/phases/P01.5/tasks/T05-c2-c3-prose-PLAN.md:
