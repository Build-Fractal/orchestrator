...
- T01..T07 outputs all landed:
  - T01: `D-RN-1..D-RN-7` block in `.orchestrator/DECISIONS.md`,
...
- The off-tree operator runbook (D-RN-2 GitHub remote rename, D-RN-5
  local clone path rename, D-RN-6 Claude memory project-key migration)
...
2. **Surface the off-tree operator runbook** for D-RN-2 / D-RN-5 /
   D-RN-6 in a structured location the consolidate-time SUMMARY can
...
5. **Verify the runbook is on disk**: `[ -f .orchestrator/milestones/M035/phases/P01.5/operator-runbook.md ]`.
