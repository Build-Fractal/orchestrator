...
- **`package.json`** declares `"name": "@build-fractal/orchestrator"`
  (D-RN-1). T03 reads this name to construct the release-artifact path
  patterns.
...
8. **Append D004 to `.orchestrator/DECISIONS.md`** — author the row
...
- `.orchestrator/DECISIONS.md` modified — contains `D004` row
