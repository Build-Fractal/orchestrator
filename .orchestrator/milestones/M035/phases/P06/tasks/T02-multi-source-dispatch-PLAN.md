...
4. **Append D014 to `.orchestrator/DECISIONS.md`**. Read the file at
...
5. **Author the verifier**
   ...
   6. The file contains all four `would_invoke=` strings (one per
      channel).
   7. `.orchestrator/DECISIONS.md` contains the literal token `D014`.
...
- `.orchestrator/DECISIONS.md` modified — contains a `D014` row
