...
- T04 is documentation-only — no script changes, no DECISIONS.md changes. The decisions D012/D013/D014 are referenced verbatim from the doc body, but their canonical authority lives in `.orchestrator/DECISIONS.md` (T01/T02/T03's responsibility).
