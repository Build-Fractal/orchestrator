...
- **No `tools/verify/m035-p06-phase-suite.sh`, no
  ...
  `.orchestrator/milestones/M035/M035-SUMMARY.md`** at plan-authoring
  time (Plan-Time Discipline Rule 6 confirmed absent).
- **Pattern reference for milestone summary** —
  `.orchestrator/milestones/M032/M032-SUMMARY.md` (122/122 PASS,
  closed 2026-05-05) and `.orchestrator/milestones/M037/M037-SUMMARY.md`
...
3. **`M035-VALIDATED` + `M035-SUMMARY.md` + milestone-grain
   ...
   summary is a structured markdown document per the M032/M037
...
3. **Author `tools/verify/m035-p06-milestone-close-shape.sh`**. ~60
   ...
   2. The marker file is non-empty AND contains a valid ISO 8601
      ...
      via `grep -qE`).
   3. `.orchestrator/milestones/M035/M035-SUMMARY.md` exists.
...
6. **Author `.orchestrator/milestones/M035/M035-SUMMARY.md`** per
...
8. **Append the milestone-grain `unit_close` JSONL event** to
   ...
   ```json
   {"event":"unit_close","unit":"M035","result":"success","verification_result":"pass","completed_at":"<ISO 8601 UTC>","summary_path":".orchestrator/milestones/M035/M035-SUMMARY.md"}
   ```
...
- `.orchestrator/milestones/M035/M035-SUMMARY.md` exists, populated
...
- `scripts/verify/validate-milestone.sh` — framework-side milestone
  ...
  writing the marker.
- `.orchestrator/milestones/M032/M032-SUMMARY.md` and
  `.orchestrator/milestones/M037/M037-SUMMARY.md` — recent canonical
