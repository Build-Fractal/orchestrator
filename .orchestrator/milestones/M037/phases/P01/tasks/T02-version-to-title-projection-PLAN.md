...
- `scripts/wiki/wiki-generate-stubs.sh` — extended with `derive_stub_title` step. Existing M032 functions (read frontmatter, emit stub) remain callable; `derive_stub_title` is a new pre-emit step.
