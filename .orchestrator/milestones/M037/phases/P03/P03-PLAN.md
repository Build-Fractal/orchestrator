...
- **P1.3** — `scripts/lifecycle/wiki-init.sh` final step: invokes
  ...
  titles instead of the bundle's literal upstream `M030+/proposals/*`
  tree.
...
and P3.2 file-feedback aside / M032 dual-template surface shipped in
...
per `.orchestrator/proposals/M037-fr-12-17-deferred-scope.md`. The
...
- M036a P03 live-LLM smoke (parallel pre-launch operational follow-up,
  ...
  to wiki polish.
- FR-12..FR-17 deferral: `.orchestrator/proposals/M037-fr-12-17-deferred-scope.md`
