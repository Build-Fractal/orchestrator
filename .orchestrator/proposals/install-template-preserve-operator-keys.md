...
**Status:** Deferred — fast-follow for M025/M033 install territory.
**Authored:** 2026-05-06.
...
Belongs as a fast-follow when M025 (installer coexistence) or M033
(project onboarding experience) next surface for paper-cut work, OR
when M035 P00–P01 (pre-launch dev-ergonomics) ships and revisits the
