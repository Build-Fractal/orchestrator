...
**Sequencing**: Independent of M033 / M032 / M029 — can land any time after M033 closes (which it has). Does not block any pre-launch milestone; does not require any pre-launch milestone.
...
- **Quick/Standard/Full** from M031 (per-task intensity profile)
