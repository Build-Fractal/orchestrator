...
conversus used (M030 routing decides at deliberation time; the
...
1. The M019 Tier 1 JSONL stream is the cost-rollup oracle for
...
- Evidence:
  `.orchestrator/milestones/M036/M036-ACCEPTANCE-EVIDENCE.md` § "Issues Surfaced — C3"
- Hardcoded site:
  `tests/m036-acceptance/live-llm-smoke/run-smoke.sh:134`
