...
Compare to spec 032 (M030, 2026-04-30) which emitted a Pass-3-aware record:
...
Not blocking M032 entry into planning — the spec is shippable without this observability fix — but worth catching before M030's adaptive-model selection starts depending on richer per-command cost/quality signals that this gap will hide.
...
Estimated cost: ≤ 1 hour (single-file edit + test). Demand-driven; ship when M030/M031 cost-and-quality consumers start reading these records.
