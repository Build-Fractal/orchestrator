# Paper-cut Sweep — M032 wiki tooling, PBJ-central dogfood
...
tooling end-to-end. Precedent: `papercut-sweep/pre-M030` branch
...
`top:decisions` → `wiki/docs/decisions.md` for `.orchestrator/DECISIONS.md`.
...
`.orchestrator/proposals/m032-cross-link-rewrite-warnings.md` (separate
brief authored alongside this sweep).

### B6 — Tier 1 extraction skipped SimplePBJ DOCX (M030/M036 lineage)
...
domain. Tracked at `.orchestrator/proposals/m036-tier-1-docx-extraction-gap.md`
for M030/M036 follow-up. **Not blocking M035 launch.**
...
6. B5 + B6 explicitly out of scope, tracking briefs at
   `.orchestrator/proposals/m032-cross-link-rewrite-warnings.md` and
   `.orchestrator/proposals/m036-tier-1-docx-extraction-gap.md`.
