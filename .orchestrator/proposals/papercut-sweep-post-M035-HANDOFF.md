...
### WS1 PC-5 — M032 SC-5 SKIP→PASS + evidence doc reconciliation
...
3. **Evidence doc patch** at `.orchestrator/milestones/M032/M032-ACCEPTANCE-EVIDENCE.md` (~10 touchpoints):
