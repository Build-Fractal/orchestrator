You are executing Phase 4 of a 5-phase hardening plan for the spec-kit-orchestrator extension (v0.2.0). This is an active implementation task — you should write code, not just plan.
