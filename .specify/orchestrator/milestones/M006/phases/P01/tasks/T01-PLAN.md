...
5. **Subsystem Relationship Map** — how M001-M005 subsystems relate:
   - M001 (Foundation): state machine, verification, knowledge, dispatch scaffolding
   - M002 (Knowledge Architecture): knowledge lifecycle, graph relationships, scope filtering
   - M003 (Migration): adapter-based migration from GSD/spec-kit
   - M004 (Engine): run.sh pipeline, library extraction, recipe-driven context
