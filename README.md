...
[![Version](https://img.shields.io/badge/version-v0.10.3-green.svg)](./CHANGELOG.md)
...
**v0.10.3** — published across npm / Homebrew / curl, in production use and **dogfooded daily on its own development**. Dozens of milestones closed (latest: M045 self-continuing auto — `orchestrator:auto --self-continue`, 2026-07-01; M044 knowledge-activation reliability, 2026-06-07; M034 interactive review gates, 2026-06-06; M043 Cloudflare Pages + Access wiki-deploy target, 2026-06-05; M042 `/orchestrator-corpus-gate`, 2026-05-30); the packaging & distribution launch event shipped 2026-05-09. **Cursor is a supported runtime (M009 + M034, 2026-06-06)** — native commands, dispatch backend, hooks, and interactive review gates. In flight: M046 auto-v2b unified serial core (tier-sized autonomous entry + `--unattended` safety envelope).
