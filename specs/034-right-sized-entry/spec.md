...
3. **Given** the empirical baseline corpus (US1 verifier fixture), **When** pre-M031 Quick (no knowledge) and post-M031 Quick (with knowledge) are compared on total task tokens and verifier pass rate, **Then** post-M031 Quick uses fewer total task tokens *and* has equal-or-higher pass rate.
