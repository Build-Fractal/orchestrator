...
For recommended Claude Code project permissions, see `templates/claude-settings.json`. Copy it to `.claude/settings.json` in the target project to pre-authorize orchestrator script execution and reduce permission prompts during autonomous mode.
