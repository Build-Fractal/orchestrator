...
| Decisions | 811-815 | ~100 | filtered |
| Constraints | 817-869 | ~600 | required |
| Scope | 871-885 | ~100 | required |
| Upstream Context | 887-899 | ~100 | required |
| Task Plan | 901-918 | ~100 | required |
| State Context | 920-926 | ~100 | required |
| First-Turn Completeness | 928-942 | ~100 | required |
| **Total** | | **~10400** | |
