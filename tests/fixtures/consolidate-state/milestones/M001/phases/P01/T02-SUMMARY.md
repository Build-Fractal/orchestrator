...
milestone: M001
provides:
  - "core implementation for P01/T02"
  - "test coverage for P01/T02 contracts"
key_files:
  - extension.yml
...
# T02: Implementation Summary for P01

**Implemented core functionality for P01/T02 including manifest
