...
milestone: M001
provides:
  - "core implementation for P01/T01"
  - "test coverage for P01/T01 contracts"
key_files:
  - extension.yml
...
# T01: Implementation Summary for P01

**Implemented core functionality for P01/T01 including manifest
