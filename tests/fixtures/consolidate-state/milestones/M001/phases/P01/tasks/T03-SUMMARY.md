...
milestone: M001
provides:
  - "core implementation for P01/T03"
  - "test coverage for P01/T03 contracts"
key_files:
  - extension.yml
...
# T03: Implementation Summary for P01

**Implemented core functionality for P01/T03 including manifest
