...
milestone: M001
provides:
  - "core implementation for P02/T02"
  - "test coverage for P02/T02 contracts"
key_files:
  - extension.yml
...
# T02: Implementation Summary for P02

**Implemented core functionality for P02/T02 including manifest
