...
# header + the four-key source_types: map and a default_tier: declaration.
...
for token in 'schema_version' 'type: reference-source-types' 'source_types:' 'cms-rule:' 'training-material:' 'glossary:' 'regulatory-doc:' 'default_tier:'; do
