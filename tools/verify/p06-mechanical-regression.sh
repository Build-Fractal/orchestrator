...
#
# Stages an ORCHESTRATOR_ROOT carve-out with M999/execution-log.jsonl set to
# the regression-mechanical fixture (20 records, character=mechanical,
# 12 fail / 8 pass → class_pass_rate=0.40, sample=20). Invokes
# scripts/diagnostics/check-anomalies.sh --milestone M999 with
# M030_ANOMALIES_JSONL_PATH redirected to a tmp file. Asserts:
#   - FLAGGED model_routing_regression class=mechanical line in stdout
#   - matching JSONL anomaly record appended to the tmp anomalies path
#
