...
Create `ANTIPATTERNS.md` at the orchestrator root as an append-only register of observed antipatterns. Each entry references a real incident from M001-[M003](../../../../../milestones/M003/index.md) as evidence. Antipattern entries are permanent (AD-11: no staleness decay, no lifecycle management) and serve as structural warnings that recur regardless of context.
...
2. At least 2 antipattern entries, each with:
   ...
   - Observed In: milestone reference (M001, [M002](../../../../../milestones/M002/index.md), or M003)
