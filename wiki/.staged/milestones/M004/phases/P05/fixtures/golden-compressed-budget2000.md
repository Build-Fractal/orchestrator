...
| Decisions | 23-26 | ~100 | filtered |
| Scope | 28-57 | ~400 | required |
| Upstream Context | 59-90 | ~500 | required |
| Task Plan | 92-734 | ~5600 | required |
| State Context | 736-743 | ~100 | required |
| Constraints | 745-750 | ~100 | required |
| **Total** | | **~6900** | |
...
milestone: "M004"
provides:
  - "Constitution v2.0.0 with 13 principles (I-XIII), amended Principle II requiring structured events, Sync Impact Report, ANTIPATTERNS.md append-only register with 3 entries (AP-001 through AP-003) referencing M001-[M003](../../../../../milestones/M003/index.md) incidents"
requires:
