...
- **5 independent phases** — P01-P04 and P07 can all run concurrently, which is efficient but means 5 parallel context tracks to coordinate. P07 has no dependencies on other M005 phases, only on M004 P02 (errors.sh, events.sh) and M004 P04 (recipe-parser.sh, per AD-14).
