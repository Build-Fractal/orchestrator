...
- **Recipe integration** — `source: graph` section type must integrate cleanly with [M004](../../milestones/M004/index.md) recipe system.

## Prerequisites

- M004 complete (engine + recipe system)
- [M005](../../milestones/M005/index.md) complete (content hashing for graph node change detection)
- [M006](../../milestones/M006/index.md) complete (architecture docs covering integration points)
