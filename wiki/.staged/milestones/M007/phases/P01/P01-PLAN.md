...
<!--
  ...
  Cross-milestone dependencies:
    - [M002](../../../../milestones/M002/index.md) delivered the knowledge scripts (create-entry.sh, update-entry.sh,
      rebuild-index.sh) and index-utils.sh.
    - [M005](../../../../milestones/M005/index.md) P01 delivered content hashing (scripts/lib/hash.sh).
