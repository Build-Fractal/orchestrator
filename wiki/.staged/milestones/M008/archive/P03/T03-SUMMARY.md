...
Created intensity-knowledge.sh thin wrapper over [M007](../../../../milestones/M007/index.md) knowledge pipeline. At Quick: invokes only write-summary.sh. At Standard: adds append-decision.sh. At Full: adds append-knowledge.sh + rebuild-index.sh. --dry-run flag echoes intended invocations without executing, enabling integration test of T05 without real knowledge side effects.
