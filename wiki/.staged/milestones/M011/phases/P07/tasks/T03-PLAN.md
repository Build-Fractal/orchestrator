...
- `scripts/engine/intensity-gate.sh` from [M008](../../../../../milestones/M008/index.md) exists with seven registered stages: `discuss`, `research`, `plan-phase`, `dispatch`, `verify`, `knowledge`, `auto`, `roadmap`. This task adds an eighth: `ingest`.
