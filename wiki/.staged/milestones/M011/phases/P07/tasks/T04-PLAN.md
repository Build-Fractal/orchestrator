...
8. **Create `scripts/verify/m011-p07-evidence-present.sh`** (executable). File-exists + token-contains gate for each evidence artifact produced in Step 10:
   ...
   - [`.orchestrator/milestones/M011/phases/P07/evidence/gate-result.md`](../../../../../milestones/M011/phases/P07/evidence/gate-result.md) contains `verdict:`.
...
11. **Create `docs/ingesting-arbitrary-specs.md`** (min 80 lines). Sections:
    ...
    - **Extending to new gate points**: [M013](../../../../../milestones/M013/index.md) / [M014](../../../../../milestones/M014/index.md) will add their own presets under `templates/conversus-presets/` and invoke the same adapter. Point at `commands/conversus-gate.md` for the reusable protocol.
