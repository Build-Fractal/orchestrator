...
The spec explicitly references coordination with downstream milestones ([M013](../../milestones/M013/index.md) reads Giscus threads, [M014](../../milestones/M014/index.md) ingests comment corpus, M020 decision runs off M012 outcomes), which is the Tier C signal: cross-milestone coupling that a single SDD flow cannot hold.
