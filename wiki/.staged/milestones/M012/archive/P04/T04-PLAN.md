...
This dual path is explicit in the Truths of P04-PLAN.md. The cleaner long-term pattern — a live deploy from a scheduled GitHub Action — is out of scope for M012 ([M013](../../../../milestones/M013/index.md) / [M014](../../../../milestones/M014/index.md) may wire it); M012 ships the wrapper and the record schema, and the first live push is a one-time operator action that can land before or during consolidation.
