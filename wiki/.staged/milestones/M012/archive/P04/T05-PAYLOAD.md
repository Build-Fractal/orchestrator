...
- T04 complete: [`.orchestrator/milestones/M012/phases/P04/DEPLOY-RECORD.md`](../../../../milestones/M012/phases/P04/DEPLOY-RECORD.md) exists (live or fixture-shaped).
...
8. `m012-p04-deploy-record.sh` — asserts [`.orchestrator/milestones/M012/phases/P04/DEPLOY-RECORD.md`](../../../../milestones/M012/phases/P04/DEPLOY-RECORD.md) exists with the seven required frontmatter fields (`schema_version`, `type: deploy-record`, `milestone: "M012"`, `phase: "P04"`, `deployed_url`, `commit_sha`, `deployed_at`, `deployer`) plus four `gate_*_result` fields with allowed values (`pass`, `fail`, `skip`, `pending`), and that `deployed_url` is either `http*` or `pending`.
...
- [`.orchestrator/milestones/M012/phases/P04/DEPLOY-RECORD.md`](../../../../milestones/M012/phases/P04/DEPLOY-RECORD.md) (from T04) — scanned by the deploy-record gate.
