...
- **Post-verify hook** for `on-transition` sync mode must not regress verify and must not introduce Claude Code approval prompts (SC-7), inheriting M016/[M021](../../milestones/M021/index.md) hardening.
