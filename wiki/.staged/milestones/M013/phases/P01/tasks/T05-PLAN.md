...
1. **`knowledge/spec/defect/README.md`** — the schema contract for `SPEC-DEFECT-NNN.md` files. Defines required frontmatter fields, the `status` enum, the graph-edge shape, and forward-compatibility with [M020](../../../../../milestones/M020/index.md) review-state extensions.
