...
7. **Knowledge-Layer Boundary (M013 vs. [M020](../../../../../milestones/M020/index.md))** — restate the D014 / D013 ruling: `chunk_id` is pinned to existing `SPEC-*` frontmatter, no new ID format, no review-state/query-surface/clustering here. Links to [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) D013 and D014.
...
- [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) — link source for D007 / D013 / D014.
