...
- Existing infra: `scripts/verify/anti-pattern-lint.sh` (M016/[M021](../../../../../milestones/M021/index.md) invariant) — the bash32-compat gate piggybacks on this.
