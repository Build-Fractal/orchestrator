...
- **Knowledge-Layer Boundary (FR-9 + D014)**: this task MUST NOT modify any `knowledge/spec/**/SPEC-*.md` frontmatter, `KNOWLEDGE-INDEX.md`, `scripts/knowledge/rebuild-index.sh`, or any `wiki/` file. [M020](../../../../../milestones/M020/index.md) owns schema extension.
