...
- `scripts/verify/anti-pattern-lint.sh` (M016/[M021](../../../../../milestones/M021/index.md)) is a repo-wide prompt-corpus lint. The bash32-compat gate invokes it on the M013/P03 files.
