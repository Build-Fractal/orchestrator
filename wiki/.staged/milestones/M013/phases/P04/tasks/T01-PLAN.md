...
- `.orchestrator/execution-log.jsonl` is the append-only JSONL log authored by `scripts/lifecycle/record-result.sh`. T01's `emit_tier1_record` appends records in the [M019](../../../../../milestones/M019/index.md) Tier 1 shape with `source: "runtime"` (FR-17).
