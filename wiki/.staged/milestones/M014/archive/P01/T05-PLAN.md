...
- `.orchestrator/execution-log.jsonl` exists; [M019](../../../../milestones/M019/index.md) Tier 1 emitter is live. Scripts append JSONL records via the shape documented at `references/events.md` and exemplified at `scripts/integrations/github-sync.sh` (function `emit_tier1_record`).
