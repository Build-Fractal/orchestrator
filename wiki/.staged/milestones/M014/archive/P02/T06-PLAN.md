...
- `scripts/verify/anti-pattern-lint.sh` exists from [M016](../../../../milestones/M016/index.md). `scripts/verify/m014-p01-bash32-compat.sh` precedent exists from M014/P01/T07.
