...
- [M021](../../../../milestones/M021/index.md) prompt-corpus cross-check: `scripts/comments/{fetch,classify,apply,reject,triage,comments}.sh` paths invoked under `--yes` produce zero approval-prompt-shaped strings on the primary path.
...
- `commands/comments.md` → [`.orchestrator/DECISIONS.md`](../../../../decisions.md) (cites D023)
...
- `specs/024-spec-management-extended/planning-inputs/inbox-dogfood.md` → [`.orchestrator/DECISIONS.md`](../../../../decisions.md)
