...
- [M012](../../../../milestones/M012/index.md) has shipped — `scripts/wiki/wiki-giscus-remap.sh` provides Discussion → spec-chunk pathname-keyed thread mapping. T01 consumes via shellout.
