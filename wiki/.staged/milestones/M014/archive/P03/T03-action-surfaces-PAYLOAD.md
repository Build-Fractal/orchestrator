...
# Dispatch Context -- T03-action-surfaces (Phase P03, Milestone M014)
## Manifest
...
| Task Plan | 1009-1483 | ~5200 | required |
| State Context | 1485-1491 | ~100 | required |
| First-Turn Completeness | 1493-1544 | ~600 | required |
| **Total** | | **~20000** | |
...
- M011 has shipped — `scripts/knowledge/rebuild-index.sh` exists; chunk-source-line metadata is preserved by the M011 ingest path. T03 invokes rebuild-index.sh after spec-amendment apply.
...
1. **Create `commands/comments.md`**:
   ...
   Consumes M012 wiki Giscus + [M013](../../../../milestones/M013/index.md) GitHub Issue/PR comments per FR-8/FR-9
