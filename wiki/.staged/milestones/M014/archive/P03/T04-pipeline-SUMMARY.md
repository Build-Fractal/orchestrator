...
- scripts/verify/m014-p03-auto-apply.sh: 4 PASS / 0 FAIL — case A high-conf R1 uat-bug auto-applied + [M013](../../../../milestones/M013/index.md) stub invoked; case B high-conf R4 decision-append DECISIONS.md row + event; case C low-conf R2 uat-bug queued without auto-apply; case D high-conf R9 spec-amendment ALWAYS queues (SC-5 retest).
