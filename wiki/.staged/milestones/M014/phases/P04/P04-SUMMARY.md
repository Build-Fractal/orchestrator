...
- `hardening_spec_exception: true` — `fr_count==0 AND user_story_count>=5` routes below-threshold (handles M016/[M021](../../../../milestones/M021/index.md) hardening-spec pattern where user stories exist but no FR-list).
...
**Calibration corpus** (T01 → [`.orchestrator/milestones/M014/phases/P04/CALIBRATION-MEMO.md`](../../../../milestones/M014/phases/P04/CALIBRATION-MEMO.md)):
- Six retrospective specs labeled: [M011](../../../../milestones/M011/index.md) above (fr_count=16), [M013](../../../../milestones/M013/index.md) above (fr_count=18), [M016](../../../../milestones/M016/index.md) below (hardening exception, fr_count=0), M021 below (hardening exception, fr_count=0), M022 above (user_story_count=5), [M024](../../../../milestones/M024/index.md) above (fr_count=20).
...
- P03 stays deferred (D018 — blocked on [M012](../../../../milestones/M012/index.md) DEPLOY-RECORD resolution + inbox dogfood data).
