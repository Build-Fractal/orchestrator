...
1. Create `scripts/verify/m015-p02-state-tree-migrated.sh` with this exact content:
   ...
   test -f [.orchestrator/KNOWLEDGE.md](../../../../../knowledge.md) || { echo "FAIL: [.orchestrator/KNOWLEDGE.md](../../../../../knowledge.md) missing"; exit 1; }
   test -f [.orchestrator/DECISIONS.md](../../../../../decisions.md) || { echo "FAIL: [.orchestrator/DECISIONS.md](../../../../../decisions.md) missing"; exit 1; }
