...
- **Four evidence streams only** — do NOT attempt to run orchestrator-auto inside the clean-clone extraction. [M003](../../../../../milestones/M003/index.md) P07/P08 already validated auto in Claude Code native mode (per the spec's stated assumption). Clean-clone here is a shape assertion, not a behavioral run.
