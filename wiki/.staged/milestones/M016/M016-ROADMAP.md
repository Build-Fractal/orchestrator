...
- [x] **P04**: Allow-List Promotion & Dogfood Validation — "A fresh `orchestrator:auto` run on a prior completed phase ([M015](../../milestones/M015/index.md) P02 or similar) using only project-default `settings.json` produces zero approval prompts."
  - Risk: medium
  - Depends: P03
  - Boundary Map:
    - Produces:
