...
2. **Cross-milestone integration surface.** M018 interacts with [M019](../../milestones/M019/index.md) (telemetry
   schema additions), [M020](../../milestones/M020/index.md) (knowledge `status:` field consumed by the filter),
   [M027](../../milestones/M027/index.md) (cost surfaces gain new savings fields), the dispatch interface
...
4. **CLAUDE.md forward roadmap pre-classifies M018 as Tier C.** The forward
   sequence (`[M014](../../milestones/M014/index.md) (extended) → M020 → [M024](../../milestones/M024/index.md) → M019 Tier 2+3 → M018 → ...`)
