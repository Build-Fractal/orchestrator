...
- [`.orchestrator/milestones/M018/phases/P05/P05-SUMMARY.md`](../../../../milestones/M018/phases/P05/P05-SUMMARY.md) (min 50 lines, contains "compression-eval.sh")
...
- **Consumes**:
  - [M019](../../../../milestones/M019/index.md) emitter schema (DEP-3 extension point) — additive fields on existing record types; no rename, no removal, no value-vocabulary change.
  - [M027](../../../../milestones/M027/index.md) surfaces (DEP-2 extension points): `metrics-rollup.sh`, `efficiency-footer.sh`, `check-anomalies.sh` — all extended additively.
