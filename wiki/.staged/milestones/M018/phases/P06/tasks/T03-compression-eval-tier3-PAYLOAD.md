...
# Dispatch Context -- T03-compression-eval-tier3 (Phase P06, Milestone M018)
## Manifest
...
| Task Plan | 1181-1405 | ~2700 | required |
| State Context | 1407-1413 | ~100 | required |
| First-Turn Completeness | 1415-1449 | ~500 | required |
| **Total** | | **~18500** | |
...
- The P05/T03 implementation of `compression-eval.sh` is the canonical shape T03 mirrors. Re-read it in full before authoring (full plan at [`.orchestrator/milestones/M018/phases/P05/tasks/T03-compression-eval-PLAN.md`](../../../../../milestones/M018/phases/P05/tasks/T03-compression-eval-PLAN.md)). Specifically the cohort-build awk pass at lines ~174-306 of the existing script.
...
- **Milestone**: M018
- **Phase**: P06
- **Task**: T03-compression-eval-tier3
- **Tier**: C
