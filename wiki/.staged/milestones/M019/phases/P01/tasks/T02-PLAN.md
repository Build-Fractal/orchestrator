...
- [`.orchestrator/milestones/M019/M019-CONTEXT.md`](../../../../../milestones/M019/M019-CONTEXT.md) — AD-1 (char-quartile), AD-5 (`<dispatch-volatile>` marker awareness — section_tokens accounting respects volatile boundaries because it operates on the same `s<i>.txt` files the emit loop consumes).
