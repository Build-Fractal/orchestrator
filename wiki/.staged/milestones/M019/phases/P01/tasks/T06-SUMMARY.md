...
- scripts/verify/m019-p01-no-pre-p00-emission.sh (81 lines) -- SC-12 ordering guard. Scans execution-log.jsonl under every post-[M011](../../../../../milestones/M011/index.md) milestone dir for M019 record_type entries (payload_breakdown/dispatch_usage/unit_close); FAILs any record whose timestamp predates P00 SUMMARY completed_at (2026-04-18T02:21:28Z). Lexical ISO-8601 compare. M011 and earlier exempted per D009.
...
- Synthetic-violation probe: injecting a pre-epoch record into a synthetic [M012](../../../../../milestones/M012/index.md) log makes no-pre-p00-emission FAIL; removing it restores PASS. Must-have satisfied.
...
Live log scan: no pre-P00 M019 emitter records exist in any post-M011 milestone (M015/M016/M019/[M021](../../../../../milestones/M021/index.md) scanned). M019 own emitter records are all post-epoch.
