...
# Dispatch Context -- T03-graduate-script (Phase P01, Milestone M020)
## Manifest
...
| Scope | 951-978 | ~200 | required |
| Upstream Context | 980-982 | ~100 | required |
| Task Plan | 984-1371 | ~3200 | required |
| State Context | 1373-1379 | ~100 | required |
| First-Turn Completeness | 1381-1420 | ~600 | required |
| **Total** | | **~15000** | |
...
- [`knowledge/conventions/MEM031.md`](../../../../../knowledge/conventions/MEM031.md) (T01) — closed enum drives the `case` statement on read status.
