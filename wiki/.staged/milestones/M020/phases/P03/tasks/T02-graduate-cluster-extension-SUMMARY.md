...
- **Operator + rationale_hash resolved once per cluster invocation** rather than per-member. Keeps the JSONL records consistent across the cluster; matches the [M019](../../../../../milestones/M019/index.md) Tier 1 emission contract.
