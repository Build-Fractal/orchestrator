...
# Dispatch Context -- T03-schema-authority-lint (Phase P03, Milestone M020)
## Manifest
...
| Task Plan | 1076-1503 | ~3800 | required |
| State Context | 1505-1511 | ~100 | required |
| First-Turn Completeness | 1513-1554 | ~800 | required |
| **Total** | | **~19500** | |
...
- **Milestone**: M020
- **Phase**: P03
- **Task**: T03-schema-authority-lint
- **Tier**: C
