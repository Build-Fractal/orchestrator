...
3. **Cluster reject**: candidate fixture of two entries; `graduate.sh --reject --cluster Crej --rationale "superseded by [M021](../../../../../milestones/M021/index.md)" MEM720 MEM721`. Asserts:
