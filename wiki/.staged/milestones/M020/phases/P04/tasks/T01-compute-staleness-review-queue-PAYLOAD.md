...
# Dispatch Context -- T01-compute-staleness-review-queue (Phase P04, Milestone M020)
## Manifest
...
| Task Plan | 1133-1547 | ~5300 | required |
| State Context | 1549-1555 | ~100 | required |
| First-Turn Completeness | 1557-1598 | ~1100 | required |
| **Total** | | **~21300** | |
...
- P01: [`knowledge/conventions/MEM031.md`](../../../../../knowledge/conventions/MEM031.md) documents the closed enum `{candidate, graduated, archived}` and the FR-10 pre-M020 default-graduated semantics.
...
- [`knowledge/conventions/MEM031.md`](../../../../../knowledge/conventions/MEM031.md) — schema authority for the closed enum; T01 does not modify this file.
...
- **Milestone**: M020
- **Phase**: P04
- **Task**: T01-compute-staleness-review-queue
- **Tier**: C
