...
# Dispatch Context -- T03-consolidate-integration (Phase P06, Milestone M020)
## Manifest
...
| Task Plan | 1164-1384 | ~3600 | required |
| State Context | 1386-1392 | ~100 | required |
| First-Turn Completeness | 1394-1435 | ~800 | required |
| **Total** | | **~21300** | |
...
- **Milestone**: M020
- **Phase**: P06
- **Task**: T03-consolidate-integration
- **Tier**: C
