...
# Dispatch Context -- T04-docs-integration-test (Phase P06, Milestone M020)
## Manifest
...
| Task Plan | 1164-1576 | ~5100 | required |
| State Context | 1578-1584 | ~100 | required |
| First-Turn Completeness | 1586-1627 | ~700 | required |
| **Total** | | **~22700** | |
...
- **Milestone**: M020
- **Phase**: P06
- **Task**: T04-docs-integration-test
- **Tier**: C
