...
M021 closed every residual Claude Code safety-prompt trigger that survived [M016](../../milestones/M016/index.md), so orchestrator:auto now runs multi-task phases to completion under project-default settings with zero user approvals. Four phases delivered a three-layer defense:
...
With M021 closed, orchestrator:auto runs on a true zero-prompt baseline — M019 Tier 1 metrics emitter can now dogfood without prompt overhead distorting duration/token measurements. Roadmap sequence post-M021: M019 Tier 1 → [M012](../../milestones/M012/index.md) → [M013](../../milestones/M013/index.md) → [M014](../../milestones/M014/index.md) → M019 Tier 2/3 → [M018](../../milestones/M018/index.md) → M009 → M010.
