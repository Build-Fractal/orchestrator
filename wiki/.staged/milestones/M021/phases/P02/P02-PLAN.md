...
- `scripts/verify/anti-pattern-lint.sh` detects all three [M016](../../../../milestones/M016/index.md) Class A patterns (command substitution `$(...)`, backtick command substitution, brace expansion `{a,b}`) on the same fixtures M016 used — v2 is a strict superset, no regression.
...
- `ANTIPATTERNS.md` (modified — appends AP-005..AP-009; min 180 lines total, contains `AP-005`, `AP-006`, `AP-007`, `AP-008`, `AP-009`, [`M011`](../../../../milestones/M011/index.md))
