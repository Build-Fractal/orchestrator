...
`ANTIPATTERNS.md` exists at the project root (117 lines, 4 entries AP-001..AP-004). It is append-only (constitution AD-11). The existing AP-004 entry documents M015/[M008](../../../../../milestones/M008/index.md) Class A patterns and already lists a remedy table. AP-005..AP-009 are new entries appended after AP-004.
...
The M011/P05–P07 screenshot evidence is the authoritative basis for the Class B pattern catalog (see [`.orchestrator/milestones/M021/M021-CONTEXT.md`](../../../../../milestones/M021/M021-CONTEXT.md) AD-2 and AD-9). The feature spec `specs/021-autonomous-hardening-v2/spec.md` enumerates the specific trigger types per category.
...
2. `**Observed In**:` — `[M011](../../../../../milestones/M011/index.md) (P05–P07 autonomous-run screenshots, 2026-04-16/2026-04-17)`
...
- [`.orchestrator/milestones/M021/M021-CONTEXT.md`](../../../../../milestones/M021/M021-CONTEXT.md) — AD-2 and AD-9 document the M021 pattern catalog; evidence bullets align with the decisions recorded there.
