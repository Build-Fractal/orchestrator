...
P03 ships the **Pre-Bash Shape Guard hook** — a PreToolUse hook that deterministically rewrites six recoverable Bash shapes into wrapper invocations or hard-rejects four shapes with a wrapper-pointing diagnostic. Together with [M016](../../../../milestones/M016/index.md)'s Class A linter, P02's Class B linter, and the P01 wrapper catalog, P03 converts the residual 12 [M011](../../../../milestones/M011/index.md) trigger classes from "user prompts" into either transparent rewrites or stay-in-the-loop rejections.
