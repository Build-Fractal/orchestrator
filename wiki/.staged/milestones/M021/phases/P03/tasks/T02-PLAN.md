...
Claude Code's PreToolUse hook protocol (per AD-1a in [`.orchestrator/milestones/M021/M021-CONTEXT.md`](../../../../../milestones/M021/M021-CONTEXT.md) and the official Claude Code hook docs at https://code.claude.com/docs/en/hooks):
