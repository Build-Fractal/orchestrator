...
# Dispatch Context -- T01 (Phase P01, Milestone M024)
## Manifest
...
| Task Plan | 985-1205 | ~1800 | required |
| State Context | 1207-1213 | ~100 | required |
| First-Turn Completeness | 1215-1251 | ~400 | required |
| **Total** | | **~13600** | |
...
The frontmatter key set is the FR-15 / DC-5 strict-superset seed: every key in the M014 interim manifest must appear here, plus the six routing axes. The exact key list is pinned by this task and must not be reordered, renamed, or added-to in later phases without a Decision row.
