...
- The five-shape enum is closed in P01. Adding a sixth shape (e.g., [M013](../../../../milestones/M013/index.md) UAT-bug per SB-2) requires a Decision row, not an in-place edit.
