...
- P01 complete: `tests/fixtures/m014-interim-manifest-keys.txt` is the contracted snapshot of [M014](../../../../milestones/M014/index.md) manifest keys (six keys: `schema_version`, `type`, `feature_slug`, `created_at`, `status`, `milestone`).
