...
# Dispatch Context -- T03 (Phase P03, Milestone M024)
## Manifest
...
| Task Plan | 1049-1392 | ~3900 | required |
| State Context | 1394-1400 | ~100 | required |
| First-Turn Completeness | 1402-1443 | ~700 | required |
| **Total** | | **~17900** | |
...
### `scripts/intake/route-to-specify.sh` — M024 → M014 handshake (#DQ-2)
