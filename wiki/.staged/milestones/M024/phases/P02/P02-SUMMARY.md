...
P02 (Spec-path backward compat + [M014](../../../../milestones/M014/index.md)→M024 manifest read direction) closes the spec branch of `orchestrator:evaluate` against three orthogonal contracts:
