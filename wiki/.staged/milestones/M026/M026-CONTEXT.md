...
<!-- Key architectural choices for this milestone.
     ...
     in [.orchestrator/DECISIONS.md](../../decisions.md) + the parity scratch at
...
a paid-dependent preset, which won't happen until [M018](../../milestones/M018/index.md) plans red-team + domain/security
...
### AD-4. JSONL `edition` field is additive, placement follows [M019](../../milestones/M019/index.md) precedent
...
extensions). Do NOT graduate entries into `knowledge/spec/**` — that's [M020](../../milestones/M020/index.md)'s schema
...
4. Parity audit artifact [`.orchestrator/milestones/M026/M026-CONVERSUS-PARITY.md`](../../milestones/M026/M026-CONVERSUS-PARITY.md) (FR-9) — multi-hundred-line markdown table with `Verified:` column populated by actual fs-inspection of both trees.
...
4. Reopening spec 026 ([M014](../../milestones/M014/index.md) three-pass shell impl) scope. Its adapter-invocation
...
- New D-row in [`.orchestrator/DECISIONS.md`](../../decisions.md) naming the edition-resolution pattern (likely D020).
