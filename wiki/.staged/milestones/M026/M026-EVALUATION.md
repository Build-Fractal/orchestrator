...
1. **Cross-repo touchpoints**. The work spans three repos at the boundary: this
   ...
   M011/M013/[M014](../../milestones/M014/index.md) and future M018/M023/[M024](../../milestones/M024/index.md) consumers depend on.
...
3. **Rollback concerns + cross-cut with in-flight specs**. Five open questions
   (#OQ-1..#OQ-5) touch on-flight work: spec 025 ([M020](../../milestones/M020/index.md)) `Ready-for-discuss-gate-deferred`
...
4. **Dependency graph + boundary map required**. Six doc surfaces must be kept in sync;
   ...
   lands additively and is consumed by [M019](../../milestones/M019/index.md) Tier 2+3 rollups downstream. Tier C's
...
- **Five load-bearing invariants preserved** (CON-1..CON-5). Each is a cross-milestone
  contract ([M011](../../milestones/M011/index.md) adapter, [M013](../../milestones/M013/index.md) UAT gate, M014 three-pass, D019 TODO pre-flight, bash
