...
- **SB-5 Option A sequencing** — the whole milestone lands before spec 026's [M014](../../milestones/M014/index.md) shell-impl Pass-3 wiring. If spec 026 begins its shell-impl phase before M026 P02 closes, M026 adds a retroactive-test-update task to the affected phase (~half a day per DC-3).
