...
- MEM027 ([`knowledge/patterns/MEM027.md`](../../../../knowledge/patterns/MEM027.md)) is the most recent shape exemplar — graduated from [M025](../../../../milestones/M025/index.md) with frontmatter (`id`, `scope_tags`, `category`, `confidence`, `created_at`, `last_verified`, `hit_count`, `source_unit`, `source_type`, `supersedes`, `superseded_by`, `relates_to`, `content_hash`) plus body sections `## Problem`, `## Pattern`, `## Gate shape`.
