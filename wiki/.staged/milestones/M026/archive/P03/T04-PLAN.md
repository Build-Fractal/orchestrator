...
- [`.orchestrator/DECISIONS.md`](../../../../decisions.md) exists. Last existing row is **D021** (recorded 2026-04-24, the bbt-companion hotfix batch). T04 adds **D022**.
- `CHANGELOG.md` exists at the repo root. Current version heading is **v0.9.1** (per CLAUDE.md project status).
- Roadmap §P03 Boundary Map and DC-2 specify: "new D-row in [`.orchestrator/DECISIONS.md`](../../../../decisions.md) naming the edition-resolution pattern" and "`CHANGELOG.md` entry under the current version heading".
...
- "Truth: [.orchestrator/DECISIONS.md](../../../../decisions.md) gains a new D### row naming the edition-resolution precedence decision, and CHANGELOG.md records the M026 migration entry under the current version heading"
- Artifacts: [`.orchestrator/DECISIONS.md`](../../../../decisions.md) (modified), `CHANGELOG.md` (modified), `scripts/verify/m026-p03-decision-row.sh`
...
- [`.orchestrator/DECISIONS.md`](../../../../decisions.md) — append target.
...
- [`.orchestrator/DECISIONS.md`](../../../../decisions.md) — modified: one new row D022 appended.
