...
3. **`m027-p01-cost-command-shape.sh`** (~50 lines):
   ...
   - Assert `grep -qF "Estimates use [M019](../../../../milestones/M019/index.md) char-quartile token approximation and pricing.yml rates; actual cost typically lands within +/-20%. Runtime-actuals calibration is Tier 3 (deferred)." commands/cost.md` (D027 verbatim).
