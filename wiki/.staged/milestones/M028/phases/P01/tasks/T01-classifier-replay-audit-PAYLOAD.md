...
# Dispatch Context -- T01-classifier-replay-audit (Phase P01, Milestone M028)
## Manifest
...
| Task Plan | 985-1107 | ~2100 | required |
| State Context | 1109-1115 | ~100 | required |
| First-Turn Completeness | 1117-1141 | ~500 | required |
| **Total** | | **~14000** | |
...
Replay every M028 source event through the existing [M021](../../../../../milestones/M021/index.md) classifier and produce a structured audit table. The audit is the input that T03 attributes to root causes and uses to recommend the collapse decision; it is also the staging note that P03 will consume when authoring the corpus extension.
...
4. Author `scripts/verify/m028/p01-replay-coverage.sh`. Single-script-file shape, bash 3.2 + POSIX-sh-safe. The script:
   - Verifies [`.orchestrator/milestones/M028/phases/P01/classifier-audit.md`](../../../../../milestones/M028/phases/P01/classifier-audit.md) exists.
...
```
PASS: classifier-audit.md has <N> source events, all sections well-formed
```

(N is whatever count the audit lands at — the verifier asserts ≥ 7, not an exact number.)
...
- [`.orchestrator/milestones/M028/phases/P01/classifier-audit.md`](../../../../../milestones/M028/phases/P01/classifier-audit.md) — markdown, ≥ 7 source-event sections, ≥ 30 lines total, contains the literal substring `AP-009`.
...
- Standard task summary at [`.orchestrator/milestones/M028/phases/P01/tasks/T01-classifier-replay-audit-SUMMARY.md`](../../../../../milestones/M028/phases/P01/tasks/T01-classifier-replay-audit-SUMMARY.md) written via `scripts/state/write-summary.sh` (or whichever path the dispatch system uses) on task close.
...
- **Milestone**: M028
- **Phase**: P01
- **Task**: T01-classifier-replay-audit
- **Tier**: C
