...
# Dispatch Context -- T03-collapse-decision-evidence (Phase P01, Milestone M028)
## Manifest
...
| Task Plan | 985-1159 | ~3200 | required |
| State Context | 1161-1167 | ~100 | required |
| First-Turn Completeness | 1169-1193 | ~600 | required |
| **Total** | | **~15200** | |
...
- **Milestone**: M028
- **Phase**: P01
- **Task**: T03-collapse-decision-evidence
- **Tier**: C
