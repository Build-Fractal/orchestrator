...
# Dispatch Context -- T02-adapter-absolute-paths (Phase P02, Milestone M028)
## Manifest
...
| Task Plan | 1050-1197 | ~3400 | required |
| State Context | 1199-1205 | ~100 | required |
| First-Turn Completeness | 1207-1241 | ~700 | required |
| **Total** | | **~18600** | |
...
- **Milestone**: M028
- **Phase**: P02
- **Task**: T02-adapter-absolute-paths
- **Tier**: C
