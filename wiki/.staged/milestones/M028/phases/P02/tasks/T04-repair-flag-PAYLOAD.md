...
# Dispatch Context -- T04-repair-flag (Phase P02, Milestone M028)
## Manifest
...
| Task Plan | 1050-1242 | ~4100 | required |
| State Context | 1244-1250 | ~100 | required |
| First-Turn Completeness | 1252-1287 | ~700 | required |
| **Total** | | **~19300** | |
...
3. Insert the `--repair` mode block after the `--uninstall` block, before the `--probe` invocation. Verbatim shape:
    ...
    # cleanup performed for the operator during [M018](../../../../../milestones/M018/index.md) close. Strict-tuple
