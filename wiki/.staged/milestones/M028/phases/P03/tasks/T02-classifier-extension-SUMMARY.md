...
Extended `scripts/verify/lib/shape-classifier.sh` with five new pattern detectors closing the gap between in-the-wild Claude-Code-prompted shapes and the [M021](../../../../../milestones/M021/index.md) reject matrix. Closes FR-8 through FR-12 of the M028 spec; preserves CON-7 strict-superset (all 20 M021 corpus entries replay with verdicts unchanged).
