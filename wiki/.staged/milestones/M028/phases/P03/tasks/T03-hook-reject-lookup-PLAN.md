...
This task addresses the phase Truth: "The PreToolUse hook's `reject_lookup` maps every new pattern class ... and every existing [M021](../../../../../milestones/M021/index.md) pattern class is preserved unchanged."
