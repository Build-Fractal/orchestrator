...
# Dispatch Context -- T03-investigation-section (Phase P04, Milestone M028)
## Manifest
...
| Task Plan | 1031-1372 | ~4400 | required |
| State Context | 1374-1380 | ~100 | required |
| First-Turn Completeness | 1382-1428 | ~700 | required |
| **Total** | | **~25200** | |
...
- **CON-7 (no-M021-regression)**: T03 must not introduce any line into the three documentation surfaces that trips an M021 AP-001..AP-009 heuristic. The lint passes are the gate; the canonical wrapper-invocation examples were chosen specifically to be shape-clean (no compound `;`/`&&`/`||`, no quoted brace, no backtick-in-regex).
...
- **Milestone**: M028
- **Phase**: P04
- **Task**: T03-investigation-section
- **Tier**: C
