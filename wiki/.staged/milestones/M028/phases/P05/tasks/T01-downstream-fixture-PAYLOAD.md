...
# Dispatch Context -- T01-downstream-fixture (Phase P05, Milestone M028)
## Manifest
...
| Task Plan | 1072-1430 | ~4800 | required |
| State Context | 1432-1438 | ~100 | required |
| First-Turn Completeness | 1440-1472 | ~600 | required |
| **Total** | | **~35200** | |
...
3. Author `tests/fixtures/downstream-project/README.md` (~30 lines). Plain markdown explaining:
   ...
   - The substring `_orchestrator_managed` (so the README documents the M025 invariant).
