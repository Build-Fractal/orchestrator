...
# Dispatch Context -- T03-regression-gate (Phase P05, Milestone M028)
## Manifest
...
| Task Plan | 1072-1435 | ~4300 | required |
| State Context | 1437-1443 | ~100 | required |
| First-Turn Completeness | 1445-1480 | ~700 | required |
| **Total** | | **~34800** | |
...
2. **corpus replay** (`tests/run-prompt-corpus-replay.sh`) — 27-entry combined M021 + M028 classifier replay with `WOULD_PROMPT=0/27` (SC-1, SC-8).
