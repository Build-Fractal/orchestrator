...
# Dispatch Context -- T05-context-skill (Phase P01, Milestone M029)
## Manifest
...
| Task Plan | 985-1161 | ~3800 | required |
| State Context | 1163-1169 | ~100 | required |
| First-Turn Completeness | 1171-1232 | ~1000 | required |
| **Total** | | **~16900** | |
...
- `commands/context.md`
- `tests/m029-acceptance/p01-sc4-context.sh`
- `tools/verify/m029-p01-context-skill-shape.sh`
- `tools/verify/m029-p01-sc4-shape.sh`
...
- A summary file at [`.orchestrator/milestones/M029/phases/P01/tasks/T05-context-skill-SUMMARY.md`](../../../../../milestones/M029/phases/P01/tasks/T05-context-skill-SUMMARY.md) documents the deliverables.
