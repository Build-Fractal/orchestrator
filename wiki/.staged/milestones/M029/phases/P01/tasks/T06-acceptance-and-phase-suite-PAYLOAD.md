...
# Dispatch Context -- T06-acceptance-and-phase-suite (Phase P01, Milestone M029)
## Manifest
...
| Task Plan | 985-1200 | ~4100 | required |
| State Context | 1202-1208 | ~100 | required |
| First-Turn Completeness | 1210-1274 | ~1100 | required |
| **Total** | | **~17300** | |
...
4. `tools/verify/m029-p01-scope-guard.sh` — greps the staged diff for any out-of-claim path; FAILs if any P02/P03 deliverable, M013/M019/M020/M027 surface, or other framework file outside the P01 Files Likely Touched list is touched.
...
4. **Author `tools/verify/m029-p01-scope-guard.sh`** (≥50 lines, executable). The verifier:
   ...
   - Defines the denylist (files explicitly out of P01 claim):
     ...
     - [`.orchestrator/KNOWLEDGE.md`](../../../../../knowledge.md) — M020 owned
     - `.orchestrator/integrations/github.json` — [M013](../../../../../milestones/M013/index.md) owned
     - Any path matching `.orchestrator/milestones/M[0-9]+/execution-log.jsonl` — M019 owned
...
- **Milestone**: M029
- **Phase**: P01
- **Task**: T06-acceptance-and-phase-suite
- **Tier**: C
