...
- The M029 spec (`specs/037-roadmap-visibility-cli-ux/spec.md` SC-8) and context draft ([`.orchestrator/milestones/M029/M029-CONTEXT.md`](../../../../../milestones/M029/M029-CONTEXT.md) AD-4) define the SC-8 oracle interface; restated inline below.
...
- [`.orchestrator/milestones/M029/M029-EVALUATION.md`](../../../../../milestones/M029/M029-EVALUATION.md) (if present) — `intensity:` source. If absent, T02 returns `intensity=unknown`.
- [`.orchestrator/milestones/M029/M029-ROADMAP.md`](../../../../../milestones/M029/M029-ROADMAP.md) — milestone name source for `--format=text`.
...
- **Per CON-7 + AD-8**: T02 introduces NO new schema additions to [M013](../../../../../milestones/M013/index.md) sidecar, [M019](../../../../../milestones/M019/index.md) JSONL, [M020](../../../../../milestones/M020/index.md) KNOWLEDGE.md, or M027 surfaces. The new `scripts/diagnostics/*.sh` and `tools/verify/*.sh` files are the only artifacts.
...
- A summary file at [`.orchestrator/milestones/M029/phases/P02/tasks/T02-summarize-milestone-SUMMARY.md`](../../../../../milestones/M029/phases/P02/tasks/T02-summarize-milestone-SUMMARY.md) documents the deliverables.
