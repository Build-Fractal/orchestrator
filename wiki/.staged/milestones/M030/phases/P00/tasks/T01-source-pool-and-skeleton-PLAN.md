...
- Working tree at `~/Sites/orchestrator/` with `.orchestrator/milestones/M*/` populated by closed milestones (M001–[M027](../../../../../milestones/M027/index.md) all have `phases/` or `archive/` subtrees containing `T*-PLAN.md` files — 455 candidates available as of P00 plan time).
