...
- [`.orchestrator/milestones/M030/M030-CONTEXT.md`](../../../../milestones/M030/M030-CONTEXT.md) → `references/model-routing.md` (D-A1 makes the classifier-confidence stability metric load-bearing for Principle II; D-A6 names the cost_rates: SSOT + operator update obligation)
