...
# Dispatch Context -- T03-routing-table-and-docs (Phase P01, Milestone M030)
## Manifest
...
| Task Plan | 1049-1330 | ~4400 | required |
| State Context | 1332-1338 | ~100 | required |
| First-Turn Completeness | 1340-1378 | ~700 | required |
| **Total** | | **~18300** | |
...
- [`.orchestrator/milestones/M030/M030-CONTEXT.md`](../../../../../milestones/M030/M030-CONTEXT.md) D-A1 (lines 14-25; classifier-calibration semantics for the stability metric), D-A3 (lines 32-36; partially_ready verdict consumes the per-class threshold), D-A6 (lines 52-56; cost_rates: SSOT), D-A8 (lines 64-68; min_tier ≠ partial-flip).
...
- **Milestone**: M030
- **Phase**: P01
- **Task**: T03-routing-table-and-docs
- **Tier**: C
