...
- [`.orchestrator/milestones/M030/M030-CONTEXT.md`](../../../../milestones/M030/M030-CONTEXT.md) → `scripts/diagnostics/shadow-compare.sh` (D-A1 makes shadow-mode a classifier-calibration gate; D-A3 names the `partially_ready` partial-flip path; D-A7 names SC-3a)
