...
- [.orchestrator/milestones/M030/M030-CONTEXT.md](../../../../milestones/M030/M030-CONTEXT.md) → scripts/dispatch/dispatch-interface.sh (D-A5 amends CON-4 with the kill-switch supersedes min_tier compound case — implementation surface is dispatch-interface)
