...
- Existing [M027](../../../../../milestones/M027/index.md) cross-surface scripts:
...
- **Project-owned-verifier-paths discipline ([M032](../../../../../milestones/M032/index.md) Finding A)**: the three new verifiers + the runner live under `tools/verify/` and `tests/m030-acceptance/` respectively (slug-bearing paths; not under `scripts/verify/`).
