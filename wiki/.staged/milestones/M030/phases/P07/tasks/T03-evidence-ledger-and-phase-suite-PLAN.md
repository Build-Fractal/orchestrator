...
- **Project-owned-verifier-paths discipline ([M032](../../../../../milestones/M032/index.md) Finding A)**: the two new verifiers live under `tools/verify/` (slug-bearing). The ledger lives under `.orchestrator/milestones/M030/` (state-tree, project-owned).
