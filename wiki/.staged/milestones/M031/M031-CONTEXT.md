...
- `knowledge/**` schema, content, indexer, or traversal logic — [M020](../../milestones/M020/index.md) (closed).
- `scripts/cost/` — M027 (closed).
- `scripts/dispatch/adapters/router/` — [M030](../../milestones/M030/index.md) model routing (closed).
- `scripts/auto/loop/` — [M028](../../milestones/M028/index.md) auto-loop (closed).
- Wiki / GitHub knowledge sync — [M012](../../milestones/M012/index.md) / [M013](../../milestones/M013/index.md) (closed); M031 changes how knowledge is *injected*, not how it is *authored*.
