...
# Dispatch Context -- T02-corpus-and-defaults (Phase P00, Milestone M031)
## Manifest
...
| Task Plan | 985-1261 | ~5300 | required |
| State Context | 1263-1269 | ~100 | required |
| First-Turn Completeness | 1271-1321 | ~900 | required |
| **Total** | | **~17900** | |
...
- `references/RUNTIME-ASSUMPTIONS.md` exists at repo root (seeded by [M018](../../../../../milestones/M018/index.md) / [M030](../../../../../milestones/M030/index.md) for cross-runtime parity documentation). Confirm via `[ -f references/RUNTIME-ASSUMPTIONS.md ]`.
