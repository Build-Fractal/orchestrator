...
# Dispatch Context -- T01-build-context-profile (Phase P01, Milestone M031)
## Manifest
...
| Task Plan | 1043-1209 | ~3800 | required |
| State Context | 1211-1217 | ~100 | required |
| First-Turn Completeness | 1219-1267 | ~800 | required |
| **Total** | | **~18300** | |
...
- **Verifier path discipline (AD-19 + [M032](../../../../../milestones/M032/index.md) Finding A)**: project-owned slug-bearing verifiers live under `tools/verify/`, NOT `scripts/verify/`. The M031-namespaced prefix `m031-p01-` avoids collision with M030's `p01-*` verifiers in the shared tree.
...
- **Milestone**: M031
- **Phase**: P01
- **Task**: T01-build-context-profile
- **Tier**: C
