...
- P00 complete: `references/RUNTIME-ASSUMPTIONS.md` documents the [M018](../../../../../milestones/M018/index.md) tier-1 `inline_threshold_tokens=1500` value (verified by `bash tools/verify/p00-runtime-assumptions-foldin.sh`).
...
Schema is additive — implementations MAY add fields, but the five named keys MUST appear with the named types. The sidecar is the cross-milestone interface contract for [M029](../../../../../milestones/M029/index.md)'s `orchestrator:where` summary line and [M036](../../../../../milestones/M036/index.md)'s reference-corpus ingest scoping (both consume the sidecar without reinventing the interface).
...
- **Verifier path discipline (AD-19 + [M032](../../../../../milestones/M032/index.md) Finding A)**: project-owned slug-bearing verifiers live under `tools/verify/`, NOT `scripts/verify/`. The M031-namespaced prefix `m031-p01-` avoids collision with [M030](../../../../../milestones/M030/index.md)'s `p01-*` verifiers in the shared tree.
