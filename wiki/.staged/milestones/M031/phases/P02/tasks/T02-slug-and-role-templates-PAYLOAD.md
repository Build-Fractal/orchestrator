...
# Dispatch Context -- T02-slug-and-role-templates (Phase P02, Milestone M031)
## Manifest
...
| Task Plan | 1058-1257 | ~3800 | required |
| State Context | 1259-1265 | ~100 | required |
| First-Turn Completeness | 1267-1324 | ~900 | required |
| **Total** | | **~19100** | |
...
- The role templates' YAML frontmatter `type: dispatch-role` is a new schema entry. M031 P02 reserves the type; future milestones extending dispatch-role surfaces (e.g., [M033](../../../../../milestones/M033/index.md) onboarding) MAY add fields additively but MUST NOT introduce a parallel role-template schema.
...
- **Milestone**: M031
- **Phase**: P02
- **Task**: T02-slug-and-role-templates
- **Tier**: C
