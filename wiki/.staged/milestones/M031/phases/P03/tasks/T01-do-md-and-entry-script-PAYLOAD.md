...
# Dispatch Context -- T01-do-md-and-entry-script (Phase P03, Milestone M031)
## Manifest
...
| Task Plan | 1108-1520 | ~7800 | required |
| State Context | 1522-1528 | ~100 | required |
| First-Turn Completeness | 1530-1585 | ~1100 | required |
| **Total** | | **~28100** | |
...
- **Milestone**: M031
- **Phase**: P03
- **Task**: T01-do-md-and-entry-script
- **Tier**: C
