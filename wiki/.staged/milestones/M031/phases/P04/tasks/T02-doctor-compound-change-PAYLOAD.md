...
# Dispatch Context -- T02-doctor-compound-change (Phase P04, Milestone M031)
## Manifest
...
| Task Plan | 1164-1473 | ~4500 | required |
| State Context | 1475-1481 | ~100 | required |
| First-Turn Completeness | 1483-1544 | ~1100 | required |
| **Total** | | **~27800** | |
...
- **Milestone**: M031
- **Phase**: P04
- **Task**: T02-doctor-compound-change
- **Tier**: C
