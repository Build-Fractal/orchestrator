...
# Dispatch Context -- T03-budget-drift-warning (Phase P04, Milestone M031)
## Manifest
...
| Task Plan | 1164-1494 | ~4600 | required |
| State Context | 1496-1502 | ~100 | required |
| First-Turn Completeness | 1504-1566 | ~1000 | required |
| **Total** | | **~27800** | |
...
- The [M027](../../../../../milestones/M027/index.md) efficiency-footer JSONL stream convention is in place — the script reads `payload_breakdown` records and emits efficiency-footer JSONL records with structured fields.
...
- **Real-app smoke test pending** (plan-time discipline rule 5): the test exercises the function via env-override fixture streams. Production confirmation that an operator running 7 consecutive Quick dispatches with high knowledge-injection sees the warning in their efficiency-footer JSONL stream is the [M033](../../../../../milestones/M033/index.md) onboarding milestone's job; T03's gates confirm the contract surface.
