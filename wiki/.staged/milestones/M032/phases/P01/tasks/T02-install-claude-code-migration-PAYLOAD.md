...
# Dispatch Context -- T02-install-claude-code-migration (Phase P01, Milestone M032)
## Manifest
...
| Task Plan | 984-1177 | ~3400 | required |
| State Context | 1179-1185 | ~100 | required |
| First-Turn Completeness | 1187-1245 | ~1000 | required |
| **Total** | | **~15900** | |
...
- **Milestone**: M032
- **Phase**: P01
- **Task**: T02-install-claude-code-migration
- **Tier**: C
