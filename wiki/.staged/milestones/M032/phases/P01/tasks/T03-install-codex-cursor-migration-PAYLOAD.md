...
# Dispatch Context -- T03-install-codex-cursor-migration (Phase P01, Milestone M032)
## Manifest
...
| Task Plan | 984-1091 | ~2200 | required |
| State Context | 1093-1099 | ~100 | required |
| First-Turn Completeness | 1101-1159 | ~900 | required |
| **Total** | | **~14600** | |
...
- **Milestone**: M032
- **Phase**: P01
- **Task**: T03-install-codex-cursor-migration
- **Tier**: C
