...
+ SC-7 acceptance scripts, the M032+[M033](../../../../milestones/M033/index.md) paired-launch seam tests
...
4. **T04 — glossary knowledge-adapter (FR-16 + MIT-010)**:
   ...
   M020-knowledge-record-compatible records on stdout. Honors [M031](../../../../milestones/M031/index.md)
...
- Top-level scanner record + nav-generator HAS_* flag + stub-generator
  ...
  `top:*` source types).
- Reader-only knowledge-adapter boundary: [M020](../../../../milestones/M020/index.md) retains schema-authority
