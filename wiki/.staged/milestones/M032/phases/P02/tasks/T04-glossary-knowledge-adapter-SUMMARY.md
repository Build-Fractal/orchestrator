...
T04 binds the FR-15 glossary surface (T03 deliverable) into the [M020](../../../../../milestones/M020/index.md)
...
3. **[M031](../../../../../milestones/M031/index.md) traversal contract per FR-16 / MIT-010** —
...
- **M032/P05** (`--with-wiki` paired-launch passthrough into [M033](../../../../../milestones/M033/index.md)) — the
...
- **Future `--kind=<other>` modes** — the adapter's argument-parsing seam is
  ...
  kinds) and [M036](../../../../../milestones/M036/index.md) may add `--kind=reference` (reference-corpus chunks)
