...
T04 lands the M032/M013-[M014](../../../../../milestones/M014/index.md) counter-pattern surface — the live-throwaway-GH-repo discipline CON-5 mandates and the FR-13 documentation that establishes `--with-<feature>` as the project-wide progressive-opt-in convention. The deliverable surface has three pieces that ship together:
