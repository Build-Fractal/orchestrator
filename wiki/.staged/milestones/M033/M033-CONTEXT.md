...
- All 16 NG-1..NG-16 entries from spec 036 — including: knowledge graph schema redesign ([M020](../../milestones/M020/index.md)), bundle/install infrastructure (M032), spec authoring (orchestrator:specify), migration logic (orchestrator:migrate), universal small-task entry ([M031](../../milestones/M031/index.md)), adaptive model selection (M030), AI-magic constitution generation, deep semantic codebase understanding, wiki/GH integration redesign, multi-language i18n, persistent interactive shell, profile-driven onboarding, migration from non-spec-kit/GSD tools, re-onboarding flow, cloud/team onboarding, AGENTS.md bilateral-fallback bug.
...
- M033 CONSUMES: spec 035 FR-1 bundle schema (Seam-A); spec 035 FR-11 `--with-wiki` failure-propagation (Seam-B); spec 035 FR-15 + FR-16 glossary path + adapter (Seam-C); orchestrator:migrate ([M015](../../milestones/M015/index.md)); orchestrator:github-init ([M013](../../milestones/M013/index.md)); M027/[M019](../../milestones/M019/index.md) observability infrastructure; M030 adaptive model routing; M020 knowledge-graph kinds; M031 Quick/Standard/Full traversal contract.
...
- **#Q-5 AGENTS.md bilateral-fallback impact on customblock-draft**: spec 036 #Q-5. Resolution: dual-write per FR-21 default ON (matches [M014](../../milestones/M014/index.md) pattern); respect `dual_write_agents: false` config flag.
