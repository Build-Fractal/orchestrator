...
# Dispatch Context -- T03-start-command-and-driver (Phase P01, Milestone M033)
## Manifest
...
| Task Plan | 985-1266 | ~4500 | required |
| State Context | 1268-1274 | ~100 | required |
| First-Turn Completeness | 1276-1338 | ~1100 | required |
| **Total** | | **~17400** | |
...
- **Milestone**: M033
- **Phase**: P01
- **Task**: T03-start-command-and-driver
- **Tier**: C
