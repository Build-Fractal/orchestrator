...
# Dispatch Context -- T05-acceptance-suite-and-phase-suite (Phase P01, Milestone M033)
## Manifest
...
| Task Plan | 985-1370 | ~5400 | required |
| State Context | 1372-1378 | ~100 | required |
| First-Turn Completeness | 1380-1440 | ~1100 | required |
| **Total** | | **~18300** | |
...
- **Milestone**: M033
- **Phase**: P01
- **Task**: T05-acceptance-suite-and-phase-suite
- **Tier**: C
