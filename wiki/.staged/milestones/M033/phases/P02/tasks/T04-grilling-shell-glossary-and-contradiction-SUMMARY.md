...
- For the P02 stub-mode escape valve, all wiki glossary writes are fixture-local under mktemp dir staging; the [M032](../../../../../milestones/M032/index.md) with-wiki real surface lands later. The same code path becomes real in M033 P05 with no source change.
