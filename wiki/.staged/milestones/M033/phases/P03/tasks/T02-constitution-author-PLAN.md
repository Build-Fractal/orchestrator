...
The dual-write fragment is intentionally short (one line): the FR-21 contract shaped it as a `# >>> orchestrator:recent-changes >>>` region append, and operators consume the region as a chronological log. Future runs accumulate; the helper does not deduplicate. This is the deliberate [M014](../../../../../milestones/M014/index.md) dual-write shape.
