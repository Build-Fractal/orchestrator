...
- `scripts/util/dual-write-runtime-md.sh` ([M014](../../../../../milestones/M014/index.md) closed — invoked via `--root <project-dir> --marker recent-changes --append-entry '<fragment>'` per the P03/T05 SSOT-harmonized API)
