...
# Dispatch Context -- T03-migrate-then-ingest-dup-prevention (Phase P04, Milestone M033)
## Manifest
...
| Task Plan | 1183-1357 | ~3400 | required |
| State Context | 1359-1365 | ~100 | required |
| First-Turn Completeness | 1367-1410 | ~900 | required |
| **Total** | | **~26100** | |
...
- `scripts/migrate/migrate.sh` ([M015](../../../../../milestones/M015/index.md) closed — emits MEMs to `<project-dir>/.orchestrator/knowledge/...` as part of the migration; the MEMs MUST carry the `derived_from_migrate: true` frontmatter sentinel for T03's check to fire)
...
- **Milestone**: M033
- **Phase**: P04
- **Task**: T03-migrate-then-ingest-dup-prevention
- **Tier**: C
