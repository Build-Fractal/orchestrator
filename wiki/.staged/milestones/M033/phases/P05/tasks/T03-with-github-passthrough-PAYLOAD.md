...
# Dispatch Context -- T03-with-github-passthrough (Phase P05, Milestone M033)
## Manifest
...
| Task Plan | 1155-1435 | ~3700 | required |
| State Context | 1437-1443 | ~100 | required |
| First-Turn Completeness | 1445-1496 | ~900 | required |
| **Total** | | **~28900** | |
...
- **Milestone**: M033
- **Phase**: P05
- **Task**: T03-with-github-passthrough
- **Tier**: C
