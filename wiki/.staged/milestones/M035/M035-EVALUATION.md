...
> Chunks-first metrics path probed `spec_chunks_present=true` but the chunks belong to [M016](../../milestones/M016/index.md) (autonomous hardening, `source_unit` confirms) — not M035. Falling back to raw-spec regex; recorded as `metrics_source: raw_spec`.
...
2. **Cross-milestone dependencies** are explicit in the spec: [M029](../../milestones/M029/index.md) renders the drift warning datum (M035 contributes), [M025](../../milestones/M025/index.md)'s installer-uninstall manifest must extend to symlink-mode (FR-1 boundary), [M033](../../milestones/M033/index.md) friendly-tester pass `#Q-11` overlaps early M035 phases, and [M037](../../milestones/M037/index.md) P03 wiki-stub-drift paper-cut (filed today, `papercut-wiki-stub-drift.md`) folds into M035 P00/P01 scope. Cross-phase coordination is the defining Tier C capability.
