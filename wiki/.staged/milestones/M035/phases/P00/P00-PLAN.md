...
- `tools/verify/m035-p00-npm-collision-evidence.sh` (min 15 lines, contains "[D-RN-1](../../../../decisions.md#d-rn-1-npm-package-name-build-fractalorchestrator-dr-code-029 "npm package name `@build-fractal/orchestrator` { #dr-code-029 }")")
...
- `scripts/wiki/wiki-generate-stubs.sh` and `scripts/wiki/wiki-generate-nav.sh` — pre-existing M012/[M037](../../../../milestones/M037/index.md) producers; T03's diagnostic invokes them against a tmp dir to compute the drift signal (read-only).
