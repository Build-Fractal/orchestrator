...
- [M025](../../../../../milestones/M025/index.md) reversibility-gate (CON-1) preserved: the install→install→uninstall byte-equality round-trip must continue to hold. The shape change is internal to the loop body; outputs are unchanged.
