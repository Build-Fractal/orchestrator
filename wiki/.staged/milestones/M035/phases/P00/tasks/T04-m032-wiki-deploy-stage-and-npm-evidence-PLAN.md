...
2. **Author `packaging/bundle/D-RN-1-evidence.txt`**. Run the collision check and record the result:
   ...
   - Migrate ~/.claude/projects/-Users-brettkellgren-Sites-orchestrator/ → -Sites-orchestrator/ ([D-RN-6](../../../../../decisions.md#d-rn-6-migrate-claude-memory-dir-alongside-path-rename-dr-code-034 "Migrate Claude memory dir alongside path rename { #dr-code-034 }")).
   ```
