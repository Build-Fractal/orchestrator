...
# Dispatch Context -- T03-operator-paths (Phase P01.5, Milestone M035)
## Manifest
...
| Task Plan | 1109-1296 | ~1900 | required |
| State Context | 1298-1304 | ~100 | required |
| First-Turn Completeness | 1306-1390 | ~1000 | required |
| **Total** | | **~17300** | |
...
- [D-RN-5](../../../../../decisions.md#d-rn-5-local-clone-path-sitesorchestrator-dr-code-033 "Local clone path `~/Sites/orchestrator` { #dr-code-033 }") (T01 D0XX block): local clone path is `~/Sites/orchestrator`.
...
Allowlisted historical files (RENAME-PLAN.md, archived [M008](../../../../../milestones/M008/index.md) payloads,
[`.orchestrator/proposals/papercut-sweep-pre-[M030](../../../../../milestones/M030/index.md).md`](../../../../../proposals/papercut-sweep-pre-M030.md),
...
1. **Inventory the C6 surface at task execution time**:
   ...
   - [`.orchestrator/proposals/papercut-sweep-pre-M030.md`](../../../../../proposals/papercut-sweep-pre-M030.md) (pre-rename
     session log)
   ...
   - [`.orchestrator/milestones/M035/phases/P01.5/P01.5-PLAN.md`](../../../../../milestones/M035/phases/P01.5/P01.5-PLAN.md) (this
     phase plan — same)
