...
# Dispatch Context -- T05-c2-c3-prose (Phase P01.5, Milestone M035)
## Manifest
...
| Task Plan | 1109-1277 | ~1800 | required |
| State Context | 1279-1285 | ~100 | required |
| First-Turn Completeness | 1287-1369 | ~1000 | required |
| **Total** | | **~17200** | |
...
- [D-RN-1](../../../../../decisions.md#d-rn-1-npm-package-name-build-fractalorchestrator-dr-code-029 "npm package name `@build-fractal/orchestrator` { #dr-code-029 }") = `@build-fractal/orchestrator` (T01 D0XX block) — informs
