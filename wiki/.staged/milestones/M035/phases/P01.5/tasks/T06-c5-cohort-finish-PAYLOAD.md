...
# Dispatch Context -- T06-c5-cohort-finish (Phase P01.5, Milestone M035)
## Manifest
...
| Task Plan | 1109-1373 | ~2800 | required |
| State Context | 1375-1381 | ~100 | required |
| First-Turn Completeness | 1383-1472 | ~1100 | required |
| **Total** | | **~18300** | |
...
- [D-RN-3](../../../../../decisions.md#d-rn-3-command-cohort-prefix-orchestratorcmd-dr-code-031 "Command-cohort prefix `orchestrator:<cmd>` { #dr-code-031 }") (T01 D0XX block): cohort prefix is `orchestrator:<cmd>`.
...
The earlier in-tree rename (M008/[M015](../../../../../milestones/M015/index.md) era) handled the bulk of
...
1. **`templates/claude-settings.json` — two edits in one file**:
   - Line 56: `"Skill(speckit.orchestrator.*)"` →
     ...
     from dotted-namespace to colon-prefix per [D-RN-3](../../../../../decisions.md#d-rn-3-command-cohort-prefix-orchestratorcmd-dr-code-031 "Command-cohort prefix `orchestrator:<cmd>` { #dr-code-031 }"). Verify the JSON
   ...
   - Line 64: `"Bash(bash spec-kit-orchestrator/scripts/*)"` →
     ...
     [D-RN-5](../../../../../decisions.md#d-rn-5-local-clone-path-sitesorchestrator-dr-code-033 "Local clone path `~/Sites/orchestrator` { #dr-code-033 }"); this is a relative-path token in a Bash-permission glob.
