...
# Dispatch Context -- T01-mode-flag-and-symlink-source (Phase P01, Milestone M035)
## Manifest
...
| Task Plan | 1088-1355 | ~3300 | required |
| State Context | 1357-1363 | ~100 | required |
| First-Turn Completeness | 1365-1419 | ~700 | required |
| **Total** | | **~17300** | |
...
- **No M025 or [M027](../../../../../milestones/M027/index.md) schema changes**: install-meta.txt is M035-owned
...
- **Milestone**: M035
- **Phase**: P01
- **Task**: T01-mode-flag-and-symlink-source
- **Tier**: C
