...
# Dispatch Context -- T01-package-json-and-bin (Phase P02, Milestone M035)
## Manifest
...
| Task Plan | 1021-1470 | ~3800 | required |
| State Context | 1472-1478 | ~100 | required |
| First-Turn Completeness | 1480-1551 | ~800 | required |
| **Total** | | **~22000** | |
...
- **P01.5 closed** with [`D-RN-1`](../../../../../decisions.md#d-rn-1-npm-package-name-build-fractalorchestrator-dr-code-029 "npm package name `@build-fractal/orchestrator` { #dr-code-029 }") (`@build-fractal/orchestrator`) recorded
  in [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) (anchor `dr-code-029`). This task
...
- `D001` (CI runner) and `D003` (Windows guard binding) are recorded
  in [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) as 7-column-table rows; this task
...
3. **Author `bin/orchestrator`** at the repo root with shebang `#!/usr/bin/env bash`,
   ...
   # skills (orchestrator:<cmd> prefix per [D-RN-3](../../../../../decisions.md#d-rn-3-command-cohort-prefix-orchestratorcmd-dr-code-031 "Command-cohort prefix `orchestrator:<cmd>` { #dr-code-031 }") / dr-code-031), not
...
5. **Author the package.json shape verifier** at
   ...
   check_grep '"name"[[:space:]]*:[[:space:]]*"@build-fractal/orchestrator"' \
     "name=@build-fractal/orchestrator ([D-RN-1](../../../../../decisions.md#d-rn-1-npm-package-name-build-fractalorchestrator-dr-code-029 "npm package name `@build-fractal/orchestrator` { #dr-code-029 }"))"
...
6. **Author the bin-entry verifier** at
   ...
   if bash "$BIN" 2>&1 | grep -q 'orchestrator:<cmd>'; then
     echo "PASS: no-args banner names orchestrator:<cmd> cohort prefix ([D-RN-3](../../../../../decisions.md#d-rn-3-command-cohort-prefix-orchestratorcmd-dr-code-031 "Command-cohort prefix `orchestrator:<cmd>` { #dr-code-031 }"))"
     pass=$((pass + 1))
   else
...
- Truth: `package.json` exists with the load-bearing fields
  ([D-RN-1](../../../../../decisions.md#d-rn-1-npm-package-name-build-fractalorchestrator-dr-code-029 "npm package name `@build-fractal/orchestrator` { #dr-code-029 }"), D003, CON-4)
...
- `CHANGELOG.md` — top-line `## [<version>]` entry is the version
  ...
  `/^## \[[0-9]/` regex.
- [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) — [`D-RN-1`](../../../../../decisions.md#d-rn-1-npm-package-name-build-fractalorchestrator-dr-code-029 "npm package name `@build-fractal/orchestrator` { #dr-code-029 }") (anchor `dr-code-029`)
