...
# Dispatch Context -- T03-byte-equivalence-skeleton (Phase P02, Milestone M035)
## Manifest
...
| Task Plan | 1021-1585 | ~5600 | required |
| State Context | 1587-1593 | ~100 | required |
| First-Turn Completeness | 1595-1676 | ~1000 | required |
| **Total** | | **~24000** | |
...
1. **Append `## Channel-specific metadata files` to `references/installation.md`**.
   Read the current file first (it's the existing [M032](../../../../../milestones/M032/index.md) / M035-edited
...
- **Milestone**: M035
- **Phase**: P02
- **Task**: T03-byte-equivalence-skeleton
- **Tier**: C
