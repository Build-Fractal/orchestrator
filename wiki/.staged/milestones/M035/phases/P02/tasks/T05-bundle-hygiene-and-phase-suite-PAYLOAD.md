...
# Dispatch Context -- T05-bundle-hygiene-and-phase-suite (Phase P02, Milestone M035)
## Manifest
...
| Task Plan | 1021-1648 | ~5900 | required |
| State Context | 1650-1656 | ~100 | required |
| First-Turn Completeness | 1658-1741 | ~1100 | required |
| **Total** | | **~24400** | |
...
- **`packaging/bundle/build-bundle.sh` exists** ([M032](../../../../../milestones/M032/index.md) surface).
...
3. **Append a comment-block to `packaging/bundle/manifest.yml`**
   ...
   # [.orchestrator/proposals/m035-bundle-hygiene-pre-publish-filter.md](../../../../../proposals/m035-bundle-hygiene-pre-publish-filter.md).
   ```
...
- **Milestone**: M035
- **Phase**: P02
- **Task**: T05-bundle-hygiene-and-phase-suite
- **Tier**: C
