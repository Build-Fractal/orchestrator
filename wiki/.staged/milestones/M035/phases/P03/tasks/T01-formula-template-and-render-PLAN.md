...
- `bin/orchestrator` exists, executable, prints version on
  `--version` (P02 T01).
- [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) exists (D001–D005 already recorded).
...
tarball) in [`.orchestrator/DECISIONS.md`](../../../../../decisions.md). Author the two task-grain
...
registration via [M025](../../../../../milestones/M025/index.md)'s manifest happens later when the consumer runs
...
4. **Append D007 to [`.orchestrator/DECISIONS.md`](../../../../../decisions.md).** Exact insertion
...
- Truth: `packaging/homebrew/render-formula.sh` correctly substitutes
  ...
  `m035-p03-render-formula-shape.sh`).
- Artifact: [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) contains D007.
...
- [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) — D007 is appended; existing rows
...
- D007 row format MUST match the `### DXXX — <decision>` shape used by
  D001–D005 in [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) (the rebuild-index reads
  this shape).
...
- [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) extended with the D007 row.
