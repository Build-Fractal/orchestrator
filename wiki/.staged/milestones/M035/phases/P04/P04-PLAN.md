...
- `packaging/install/install.sh` exists at the repo root, is executable,
  ...
  `orchestrator:<cmd>` cohort prefix ([D-RN-3](../../../../decisions.md#d-rn-3-command-cohort-prefix-orchestratorcmd-dr-code-031 "Command-cohort prefix `orchestrator:<cmd>` { #dr-code-031 }")) and the canonical
  repo URL (D009).
...
- [`.orchestrator/DECISIONS.md`](../../../../decisions.md) (modified — contains `### D009 —` AND
  `### D010 —` AND `### D011 —`)
...
- [`.orchestrator/DECISIONS.md`](../../../../decisions.md) (modify — append D009 row) — T01
- `.github/workflows/release.yml` (modify — `Stage release artifacts`
  step + `timeout-minutes: 20` on `npm-publish` and `homebrew-publish`
  jobs) — T02
- [`.orchestrator/DECISIONS.md`](../../../../decisions.md) (modify — append D010 row) — T02
...
- [`.orchestrator/DECISIONS.md`](../../../../decisions.md) (modify — append D011 row) — T04
...
- **Rule 1 (Prerequisite-existence)**: `package.json` (P02 T01),
  ...
  enumerating git/npm/homebrew per P03 T04), [`.orchestrator/DECISIONS.md`](../../../../decisions.md)
