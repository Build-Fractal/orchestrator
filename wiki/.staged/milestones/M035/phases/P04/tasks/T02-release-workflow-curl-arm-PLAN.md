...
- [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) exists with D009 recorded (T01 just
  appended it).
...
6. **Append D010 to [`.orchestrator/DECISIONS.md`](../../../../../decisions.md).** Use Edit. Locate
...
7. **Author `tools/verify/m035-p04-release-workflow-curl-arm.sh`.**
   ...
   #   * D010 row recorded in [.orchestrator/DECISIONS.md](../../../../../decisions.md)
   #
   ...
   # 6. D010 row recorded in [.orchestrator/DECISIONS.md](../../../../../decisions.md).
...
10. **Commit atomically.**
    ...
    ```bash
    git add .github/workflows/release.yml tools/verify/m035-p04-release-workflow-curl-arm.sh [.orchestrator/DECISIONS.md](../../../../../decisions.md)
    ...
    - [.orchestrator/DECISIONS.md](../../../../../decisions.md) D010 — CON-8 release-workflow timeout:
...
- Artifact: [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) D010 row.
...
- [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) — agent reads enough to confirm D009
...
- [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) D010 row appended.
