...
3. **D005 entry in [`.orchestrator/DECISIONS.md`](../../../../../decisions.md)** — appended as a 7-column-table row matching P02's D001/D002/D003 sibling shape (the parent installer's existing convention; the new heading-shape migration is a separate paper-cut per P02 caveats).
