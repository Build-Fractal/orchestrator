...
# Dispatch Context -- T02-rollback-dispatch (Phase P05, Milestone M035)
## Manifest
...
| Task Plan | 1049-1507 | ~4800 | required |
| State Context | 1509-1515 | ~100 | required |
| First-Turn Completeness | 1517-1584 | ~800 | required |
| **Total** | | **~23200** | |
...
- **`scripts/util/settings-merge.sh`** — M025's manifest replay path.
