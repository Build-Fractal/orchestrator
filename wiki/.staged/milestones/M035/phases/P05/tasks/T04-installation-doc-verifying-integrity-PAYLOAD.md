...
# Dispatch Context -- T04-installation-doc-verifying-integrity (Phase P05, Milestone M035)
## Manifest
...
| Task Plan | 1049-1297 | ~2500 | required |
| State Context | 1299-1305 | ~100 | required |
| First-Turn Completeness | 1307-1368 | ~800 | required |
| **Total** | | **~20900** | |
...
- **Milestone**: M035
- **Phase**: P05
- **Task**: T04-installation-doc-verifying-integrity
- **Tier**: C
