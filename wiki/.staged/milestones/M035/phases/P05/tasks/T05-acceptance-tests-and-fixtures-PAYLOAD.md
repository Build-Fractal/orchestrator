...
# Dispatch Context -- T05-acceptance-tests-and-fixtures (Phase P05, Milestone M035)
## Manifest
...
| Task Plan | 1049-1537 | ~5100 | required |
| State Context | 1539-1545 | ~100 | required |
| First-Turn Completeness | 1547-1627 | ~1000 | required |
| **Total** | | **~23700** | |
...
- **Milestone**: M035
- **Phase**: P05
- **Task**: T05-acceptance-tests-and-fixtures
- **Tier**: C
