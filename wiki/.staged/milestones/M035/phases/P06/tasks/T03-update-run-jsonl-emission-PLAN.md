...
T03's emission honors [M027](../../../../../milestones/M027/index.md)'s 5-condition matrix verbatim:
...
5. **Append D013 to [`.orchestrator/DECISIONS.md`](../../../../../decisions.md)**. Read the file at
...
6. **Author the verifier**
   ...
   6. The JSONL event template line contains all five required
      ...
      `timestamp`).
   7. [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) contains the literal token `D013`.
...
- `scripts/lifecycle/run-update.sh` modified — contains
  ...
  paths.
- [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) modified — contains a `D013` row
