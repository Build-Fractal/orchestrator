...
3. **Author `tests/m035-acceptance/run-acceptance-battery.sh`**.
   ...
   the [M029](../../../../../milestones/M029/index.md) acceptance-battery convention (chain sub-aggregators,
...
- **BATTERY-line shape consistency** — `BATTERY: pass=N fail=N
  skip=M` matches the M029/M030/M031/M032/[M037](../../../../../milestones/M037/index.md) + M035 P02/P03/P04/P05
...
- **Defensive numeric parsing** — the `case "$X" in ''|*[!0-9]*) X=0 ;;`
  ...
  cause a bash arithmetic error. Mirrors the [M027](../../../../../milestones/M027/index.md) P02 + [M032](../../../../../milestones/M032/index.md) P03
