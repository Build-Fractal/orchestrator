...
- **Backwards-compat gate as hard constraint**: CON-1 + FR-15 + SC-7 require a golden-baseline diff harness ([M030](../../milestones/M030/index.md) SC-11 shape) for the dispatch payload. This is a non-trivial test investment that must land in the same flow as the dispatch integration.
- **External deadline (2026-05-15)**: PBJ validator pilot. Drives milestone-slot placement (Open Question #Q-1 — own milestone (M036) vs [M020](../../milestones/M020/index.md).1 vs deferred-post-launch); roadmap-time decision.
...
This evaluation provisionally assigns **M036**, the next sequential milestone ID after the closed M030 and the queued [M031](../../milestones/M031/index.md)–[M035](../../milestones/M035/index.md). Open Question #Q-1 in the spec defers final slot resolution to `orchestrator:roadmap`:
