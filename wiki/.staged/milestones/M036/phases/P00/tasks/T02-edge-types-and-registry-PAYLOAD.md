...
# Dispatch Context -- T02-edge-types-and-registry (Phase P00, Milestone M036)
## Manifest
...
| Task Plan | 985-1276 | ~4000 | required |
| State Context | 1278-1284 | ~100 | required |
| First-Turn Completeness | 1286-1336 | ~900 | required |
| **Total** | | **~16500** | |
...
- `scripts/dispatch/adapters/format/` directory exists (M005 — currently contains `native.sh` and `speckit.sh`, both unrelated to reference extraction). T02 adds a new `registry.tsv` file alongside; it does NOT modify the existing two scripts.
...
- **Milestone**: M036
- **Phase**: P00
- **Task**: T02-edge-types-and-registry
- **Tier**: C
