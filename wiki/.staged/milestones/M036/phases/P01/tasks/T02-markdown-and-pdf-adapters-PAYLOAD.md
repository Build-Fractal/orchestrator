...
# Dispatch Context -- T02-markdown-and-pdf-adapters (Phase P01, Milestone M036)
## Manifest
...
| Task Plan | 1041-1195 | ~2100 | required |
| State Context | 1197-1203 | ~100 | required |
| First-Turn Completeness | 1205-1251 | ~700 | required |
| **Total** | | **~16600** | |
...
- **Milestone**: M036
- **Phase**: P01
- **Task**: T02-markdown-and-pdf-adapters
- **Tier**: C
