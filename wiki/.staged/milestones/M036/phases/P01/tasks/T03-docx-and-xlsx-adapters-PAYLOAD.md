...
# Dispatch Context -- T03-docx-and-xlsx-adapters (Phase P01, Milestone M036)
## Manifest
...
| Task Plan | 1041-1249 | ~2900 | required |
| State Context | 1251-1257 | ~100 | required |
| First-Turn Completeness | 1259-1306 | ~800 | required |
| **Total** | | **~17500** | |
...
bash scripts/dispatch/adapters/format/docx.sh tests/fixtures/m036-tier-1-adapters/sample.docx
```
...
- **Milestone**: M036
- **Phase**: P01
- **Task**: T03-docx-and-xlsx-adapters
- **Tier**: C
