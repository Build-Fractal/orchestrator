...
# Dispatch Context -- T01-manifest-contract-and-fixtures (Phase P02, Milestone M036)
## Manifest
...
| Task Plan | 1087-1512 | ~3900 | required |
| State Context | 1514-1520 | ~100 | required |
| First-Turn Completeness | 1522-1572 | ~700 | required |
| **Total** | | **~21200** | |
...
- **Milestone**: M036
- **Phase**: P02
- **Task**: T01-manifest-contract-and-fixtures
- **Tier**: C
