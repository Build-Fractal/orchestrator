...
T01 lands the M036 P03 declarative substrate: the tier-2-fidelity conversus preset, the additive `task_type:` row in the [M030](../../../../../milestones/M030/index.md) routing SSOT, the P03 Tier 2 fixture corpus (one markdown source + manifest declaring `tier: 2` + `summary_mode: "auto"`), and three single-script-file shape verifiers gating each artifact.
