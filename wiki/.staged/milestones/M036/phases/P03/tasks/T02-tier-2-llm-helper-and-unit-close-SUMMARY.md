...
- The `live` branch is intentionally a stub-error per CON-3 (no live LLM in CI) — implementation seam for M036b post-launch, captured in the plan body rather than [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) because it's an implementation seam not an architectural commitment.
