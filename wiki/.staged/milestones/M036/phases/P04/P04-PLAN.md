...
1. **Prerequisite-existence verification** — all `Prerequisites:` paths in the task plans below were `[ -f ... ]`-checked at plan-authoring time:
   ...
   - `scripts/knowledge/rebuild-index.sh` ([M011](../../../../milestones/M011/index.md) deliverable, P05-extended) — present
...
- Existing `knowledge/` directory tree (M011/[M020](../../../../milestones/M020/index.md) — `KNOWLEDGE-INDEX.md` mechanics).
