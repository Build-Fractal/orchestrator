...
# Dispatch Context -- T01-classifier-and-fixture-corpus (Phase P04, Milestone M036)
## Manifest
...
| Task Plan | 1093-1562 | ~5400 | required |
| State Context | 1564-1570 | ~100 | required |
| First-Turn Completeness | 1572-1626 | ~900 | required |
| **Total** | | **~28900** | |
...
- **Milestone**: M036
- **Phase**: P04
- **Task**: T01-classifier-and-fixture-corpus
- **Tier**: C
