...
# Dispatch Context -- T02-driver-and-rebuild-index (Phase P04, Milestone M036)
## Manifest
...
| Task Plan | 1093-1632 | ~5900 | required |
| State Context | 1634-1640 | ~100 | required |
| First-Turn Completeness | 1642-1695 | ~900 | required |
| **Total** | | **~29400** | |
...
- `scripts/knowledge/rebuild-index.sh` exists (M011/M020 deliverable, P05-extended for new edge types).
...
- **Milestone**: M036
- **Phase**: P04
- **Task**: T02-driver-and-rebuild-index
- **Tier**: C
