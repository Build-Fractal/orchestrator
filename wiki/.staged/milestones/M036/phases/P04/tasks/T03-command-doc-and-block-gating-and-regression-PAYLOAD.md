...
# Dispatch Context -- T03-command-doc-and-block-gating-and-regression (Phase P04, Milestone M036)
## Manifest
...
| Task Plan | 1093-1451 | ~5000 | required |
| State Context | 1453-1459 | ~100 | required |
| First-Turn Completeness | 1461-1514 | ~800 | required |
| **Total** | | **~28400** | |
...
- **Milestone**: M036
- **Phase**: P04
- **Task**: T03-command-doc-and-block-gating-and-regression
- **Tier**: C
