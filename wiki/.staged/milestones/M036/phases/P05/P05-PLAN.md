...
- `tools/verify/p05-*.sh` (8 files) — exist but belong to **[M030](../../../../milestones/M030/index.md)** (per filename conventions and `m030-classifier-corpus/README.md` references). M036 deliberately uses `m036-p05-*` slugs to avoid the [M031](../../../../milestones/M031/index.md)→M036 collision class P00 surfaced. No collision.
