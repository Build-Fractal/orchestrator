...
# Dispatch Context -- T03-scope-filter-source-tag (Phase P05, Milestone M036)
## Manifest
...
| Task Plan | 1041-1192 | ~2500 | required |
| State Context | 1194-1200 | ~100 | required |
| First-Turn Completeness | 1202-1238 | ~700 | required |
| **Total** | | **~16900** | |
...
- **Milestone**: M036
- **Phase**: P05
- **Task**: T03-scope-filter-source-tag
- **Tier**: C
