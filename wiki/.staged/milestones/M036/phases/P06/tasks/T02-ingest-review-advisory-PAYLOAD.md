...
# Dispatch Context -- T02-ingest-review-advisory (Phase P06, Milestone M036)
## Manifest
...
| Task Plan | 1096-1654 | ~6700 | required |
| State Context | 1656-1662 | ~100 | required |
| First-Turn Completeness | 1664-1704 | ~500 | required |
| **Total** | | **~31300** | |
...
- **Milestone**: M036
- **Phase**: P06
- **Task**: T02-ingest-review-advisory
- **Tier**: C
