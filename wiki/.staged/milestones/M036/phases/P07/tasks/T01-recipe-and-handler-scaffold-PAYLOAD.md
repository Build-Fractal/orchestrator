...
# Dispatch Context -- T01-recipe-and-handler-scaffold (Phase P07, Milestone M036)
## Manifest
...
| Task Plan | 1085-1299 | ~2700 | required |
| State Context | 1301-1307 | ~100 | required |
| First-Turn Completeness | 1309-1349 | ~400 | required |
| **Total** | | **~24500** | |
...
- **Milestone**: M036
- **Phase**: P07
- **Task**: T01-recipe-and-handler-scaffold
- **Tier**: C
