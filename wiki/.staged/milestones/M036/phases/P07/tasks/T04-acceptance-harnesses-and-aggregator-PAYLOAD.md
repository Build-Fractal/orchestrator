...
# Dispatch Context -- T04-acceptance-harnesses-and-aggregator (Phase P07, Milestone M036)
## Manifest
...
| Upstream Context | 983-1083 | ~9800 | required |
| Task Plan | 1085-1462 | ~4200 | required |
| State Context | 1464-1470 | ~100 | required |
| First-Turn Completeness | 1472-1512 | ~400 | required |
| **Total** | | **~26000** | |
...
- **SC-3** — drive `T-with-topic-tags-PLAN.md` against the M036/P04 reference corpus; assert payload contains `## Reference`, contains ≥1 `### REF-` chunk header, and the reference-section character count divided by 4 ≤ 4000 (per the [M018](../../../../../milestones/M018/index.md) / M036/P07 token-estimation convention). Re-invoke with a smaller per-task budget override to confirm chunk-level dropping kicks in.
...
- **Milestone**: M036
- **Phase**: P07
- **Task**: T04-acceptance-harnesses-and-aggregator
- **Tier**: C
