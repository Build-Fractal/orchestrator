...
# T03 — DR-### heading-shape pivot for [`.orchestrator/DECISIONS.md`](../../../../../decisions.md) + framework-owned shape-lint verifier
...
|---|---|---|---|
| [`.orchestrator/milestones/M037/phases/P01/tasks/T03-decisions-shape-pivot-PLAN.md`](../../../../../milestones/M037/phases/P01/tasks/T03-decisions-shape-pivot-PLAN.md) | 3 | `#d001` (illustrative) | M037 internal; excluded by acceptance test scope per task plan. |
...
- **[`.orchestrator/DECISIONS.md`](../../../../../decisions.md)** — restructured from a 7-column markdown table
...
- **`scripts/verify/decisions-shape-lint.sh`** — new framework-owned shape-lint
  ...
  row, enforces anchor uniqueness. Default target [`.orchestrator/DECISIONS.md`](../../../../../decisions.md),
...
- **28-rows-actual vs ~150-rows-brief scope delta**: the M037 brief (proposal
  [`.orchestrator/proposals/M037-wiki-team-feedback-ready.md`](../../../../../proposals/M037-wiki-team-feedback-ready.md)) and the M037-ROADMAP
