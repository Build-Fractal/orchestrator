...
# Dispatch Context -- T04-out-of-scope-collapse (Phase P02, Milestone M037)
## Manifest
...
| Task Plan | 1083-1298 | ~3200 | required |
| State Context | 1300-1306 | ~100 | required |
| First-Turn Completeness | 1308-1352 | ~800 | required |
| **Total** | | **~20400** | |
...
- **Milestone**: M037
- **Phase**: P02
- **Task**: T04-out-of-scope-collapse
- **Tier**: C
