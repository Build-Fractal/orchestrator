# Proposal: [M028](../milestones/M028/index.md) — Autonomous Hardening v3

> **ID note**: originally drafted as [M026](../milestones/M026/index.md); renumbered to M028 after discovering M026 ("Conversus-OSS Migration", closed 2026-04-25) and [M027](../milestones/M027/index.md) ("Cost+Quality Observability Surfaces", closed 2026-04-27) had already taken those IDs. No scope conflict — only the number changed.

**Captured**: 2026-04-27 (renumbered 2026-04-28; Finding F appended 2026-04-28 during [M018](../milestones/M018/index.md) close)
**Shape**: Milestone (5 phases) — collapsible to 2 quick PRs depending on P01 baseline
**Predecessors**: [M016](../milestones/M016/index.md) (autonomous hardening v1, shipped), [M021](../milestones/M021/index.md) (autonomous hardening v2, shipped), [M025](../milestones/M025/index.md) (installer coexistence — Finding F is its follow-up)
...
**Impact**: blocks every downstream-project autonomous run. [M024](../milestones/M024/index.md) (universal intake under auto mode) is the next milestone that will exercise this path.
...
**Should land before**: M024 (universal intake under autonomous mode in arbitrary projects), [M020](../milestones/M020/index.md) (any further milestone with significant `auto` runtime).

**Independent of**: [M014](../milestones/M014/index.md) (extended), [M019](../milestones/M019/index.md) Tier 2+3, M018 (currently active), M023, M027.
...
- **Finding F sources** (added 2026-04-28 during M018 close):
  ...
  - [`.orchestrator/milestones/M025/M025-SUMMARY.md`](../milestones/M025/M025-SUMMARY.md) `affects:` field — explicitly names this carve-out as a future-milestone concern
