# Proposal: [M031](../milestones/M031/index.md) — Right-Sized Entry
...
- Knowledge layer redesign (graph schema, indexer, traversal logic) — that's [M020](../milestones/M020/index.md)'s territory and is closed
- Cost surface redesign — [M027](../milestones/M027/index.md) already shipped
- Model selection — [M030](../milestones/M030/index.md)'s job
- Auto-loop hardening — [M028](../milestones/M028/index.md)'s job
...
|---|---|---|---|---|---|
| **Quick** | Touched files only | 1-hop direct hits | Excluded by default | Touched terms only | [M018](../milestones/M018/index.md) tier-1 + tier-2 |
...
**Glossary column** is the [M032](../milestones/M032/index.md) Finding K surface (`wiki/glossary.md`). Reading it requires no graph traversal — it's a flat alphabetized file the adapter slices by term-touch rather than by hop count. Glossary inject is typically 100–400 tokens at Quick (touched terms only) and 800–1500 at Full. Adopted from `mattpocock/skills::grill-with-docs` (MIT); see [`.orchestrator/proposals/M032-wiki-distribution-and-init-integration.md`](../proposals/M032-wiki-distribution-and-init-integration.md) § Finding K for the surface design.
...
Triggered by:
- [M024](../milestones/M024/index.md) input-shape classifier emitting `tier_a_plus` for medium-complexity inputs (currently routed to either Tier A single-shot or Tier B full ceremony)
...
- `orchestrator:status`, `orchestrator:doctor`, `orchestrator:cost`, `orchestrator:resume`, `orchestrator:where` (proposed [M029](../milestones/M029/index.md))…
...
- Wiki/GitHub knowledge sync redesign — orthogonal; existing M012/[M013](../milestones/M013/index.md) paths remain
