# Proposal: [M033](../milestones/M033/index.md) — Project Onboarding Experience
...
**Predecessors**: [M031](../milestones/M031/index.md) (right-sized entry — universal task entry post-bootstrap), [M032](../milestones/M032/index.md) (wiki distribution — `--with-<feature>` flag pattern + project-asset surface), [M024](../milestones/M024/index.md) (intake & routing — intent classifier reused in greenfield ideation), [M020](../milestones/M020/index.md) (knowledge layer — graph schema M033 seeds into), [M025](../milestones/M025/index.md) (installer coexistence — user-global skills surface M033 sits atop)
...
- Adaptive model selection — [M030](../milestones/M030/index.md)'s territory
...
**Root cause**: M011-[M014](../milestones/M014/index.md) spec management focused on the *single spec* lifecycle (author → ingest → comment → amend). Heterogeneous-source intake was never scoped.
...
**Slot recommendation**: pre-launch, after M032, before [M029](../milestones/M029/index.md). Revised launch sequence:
...
- [`.orchestrator/proposals/M031-right-sized-entry.md`](../proposals/M031-right-sized-entry.md) — pair milestone (M031 small-task entry, M033 onboarding entry).
- [`.orchestrator/proposals/M032-wiki-distribution-and-init-integration.md`](../proposals/M032-wiki-distribution-and-init-integration.md) — `--with-<feature>` flag pattern + project-asset surface M033 consumes.
- [`.orchestrator/proposals/constitution-amendment-inclusion-criteria.md`](../proposals/constitution-amendment-inclusion-criteria.md) § Change 3 — Principle XVI; M033 P02 + P05 are content-authoring compliance test.
