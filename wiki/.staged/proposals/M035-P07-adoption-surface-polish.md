...
# Proposal: Adoption-Surface Polish (candidate [M035](../milestones/M035/index.md) P07)
...
prose, not adoption polish. [M037](../milestones/M037/index.md) P01/P02 polish the wiki for non-author
*existing* users, not for first-impression readers. [M033](../milestones/M033/index.md) polished the
...
- Version line refreshed to v0.9.3 (was: stuck at 0.9.2/[M018](../milestones/M018/index.md)).
...
- **Changing the doc tooling** (mkdocs, the wiki publishing pipeline) —
  M037 P01/P02 owns wiki polish; [M032](../milestones/M032/index.md) owns wiki distribution.
...
- M035 brief: [`.orchestrator/proposals/M035-packaging-distribution.md`](../proposals/M035-packaging-distribution.md) —
  parent milestone; P07 absorbs into its phase tree.
- M037 brief: [`.orchestrator/proposals/M037-wiki-team-feedback-ready.md`](../proposals/M037-wiki-team-feedback-ready.md) —
  related but distinct surface (wiki for existing users, not README for
  first-impression readers).
- M033 summary: [`.orchestrator/milestones/M033/M033-SUMMARY.md`](../milestones/M033/M033-SUMMARY.md) —
  M033's `/orchestrator-start` warm front door is the runtime-side
  counterpart to this doc-side polish.
- Constitution amendment brief: [`.orchestrator/proposals/constitution-amendment-inclusion-criteria.md`](../proposals/constitution-amendment-inclusion-criteria.md) —
