...
- `[.orchestrator/milestones/M020/M020-CONTEXT.md](../milestones/M020/M020-CONTEXT.md):210` →
  `brett@fivestar.studio`
- `[.orchestrator/milestones/M033/M033-SUMMARY.md](../milestones/M033/M033-SUMMARY.md):86` →
...
The papercut at
[`.orchestrator/proposals/install-template-preserve-operator-keys.md`](../proposals/install-template-preserve-operator-keys.md)
flags the inverse pattern (operator-authored config getting clobbered
by template re-install) and is already queued for [M035](../milestones/M035/index.md) install
...
| Reference corpus (M036a) | API keys for Tier 2 LLM extraction | [M030](../milestones/M030/index.md) routing handles in-process |
...
[`.orchestrator/proposals/papercut-discuss-project-shape.md`](../proposals/papercut-discuss-project-shape.md) —
...
|-----------------|----------------------------------------------------|---------------------------------------------------|
| wiki            | [M032](../milestones/M032/index.md) closed; `--with-wiki` ships                   | "Stand up an mkdocs wiki for team feedback?"      |
| wiki + giscus   | M032 closed; `--with-giscus` ships                 | (chained) "Add GitHub-Discussions comments?"      |
| GH integration  | [M013](../milestones/M013/index.md) closed; `--with-github` ships                 | "Project state to GitHub Issues/Projects?"        |
| Constitution    | [M033](../milestones/M033/index.md) P02 closed                                    | "Author a project constitution?"                  |
| Reference corpus | M036a closed; `commands/extract.md` invoked manually | "Have a doc corpus to ingest? (PDF/DOCX/MD)"   |
| Conversus       | [M026](../milestones/M026/index.md) closed; `commands/conversus-gate.md` exists   | "Adversarial multi-agent review on key artifacts?" |
...
Tie to the [M031](../milestones/M031/index.md) Quick/Standard/Full tier model. `start --yes`
...
- **Bundle into [M037](../milestones/M037/index.md) P02** when it enters planning. P02 is
...
- [`.orchestrator/proposals/M033-onboarding-experience.md`](../proposals/M033-onboarding-experience.md) § Findings
  D + E + F — materials intake / ideation / custom-block authoring;
  feature-menu candidates.
- [`.orchestrator/proposals/M037-wiki-team-feedback-ready.md`](../proposals/M037-wiki-team-feedback-ready.md) § P02 —
  natural home for adaptive-init slice if it grows beyond the
  paper-cut.
- [`.orchestrator/proposals/constitution-amendment-inclusion-criteria.md`](../proposals/constitution-amendment-inclusion-criteria.md)
