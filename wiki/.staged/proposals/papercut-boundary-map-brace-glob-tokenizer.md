...
Confirmed against [`.orchestrator/milestones/M032/M032-ROADMAP.md`](../milestones/M032/M032-ROADMAP.md) P01 Produces: line which contains `install-{claude-code,codex,cursor}.sh`.
...
- **[M032](../milestones/M032/index.md) P01**: load-bearing — boundary-map FAIL on `codex` is the false positive blocking P01 verification.
