...
Items 6, 7, 13, 14 from the parent scan land elsewhere ([M028](../milestones/M028/index.md) follow-up, M034 brief amendment, post-launch deferral, constitution-amendment bundle) and are NOT in this sweep.
...
**Note**: [M033](../milestones/M033/index.md)'s command surface lands during P05/T05. Run this audit AFTER M033-VALIDATED lands — otherwise we're auditing a moving target. The post-M033 timing is the right window.
...
- `orchestrator:doctor` adds checks for:
  ...
  - Exhausted retry counters from [M019](../milestones/M019/index.md) JSONL stream (configurable threshold)
...
**Source**: GSD v2.79 fix `pi-coding-agent,gsd: preserve Anthropic prompt cache (#5019)` — explicit fix because something broke the cache breakpoint position. Defensive insurance against the same drift in our M030/[M031](../milestones/M031/index.md) efficiency stack.
...
- Wired into commit-authoring paths (e.g., M033's potential commit messages, [M013](../milestones/M013/index.md) GitHub-sync commit subjects)
...
- **Item 2** (`--auto-chain` flag): folds into [M029](../milestones/M029/index.md)
