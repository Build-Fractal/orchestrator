...
# Paper-Cut: orchestrator commands wrote [M030](../milestones/M030/index.md) artifacts to `specs/NNN-slug/` instead of `.orchestrator/milestones/M###/`
...
All prior milestones ([M002](../milestones/M002/index.md)–[M028](../milestones/M028/index.md)) live at `.orchestrator/milestones/M###/`. The path mismatch is the bug, not the user's invocation.
...
- M028 brief: [`.orchestrator/proposals/M028-autonomous-hardening-v3.md`](../proposals/M028-autonomous-hardening-v3.md) (autonomous hardening shape classes)
- CLAUDE.md "[M032](../milestones/M032/index.md) spec-side invariant for staged-dirs collision" — adjacent invariant (project-owned paths must not collide with staged dirs); this paper-cut is the orchestrator-state version of the same shape concern.
