# Paper-cut Sweep round 2 — [M032](../milestones/M032/index.md) wiki tooling, PBJ-central dogfood
...
- **B7** is new — the largest single visible gap. [M036](../milestones/M036/index.md) reference-corpus
...
in [`.orchestrator/DECISIONS.md`](../decisions.md) projected into `wiki/docs/decisions.md`
...
**Note on PBJ's stronger preference:** PBJ flagged [`knowledge/index.md`](../knowledge/index.md)
...
Stays at [`.orchestrator/proposals/m036-tier-1-docx-extraction-gap.md`](../proposals/m036-tier-1-docx-extraction-gap.md)
for M030/M036 follow-up. B7's metadata-only fallback partially
mitigates by surfacing `external_pointer:` in the stub.

### Install-template config.yml preservation (M025/[M033](../milestones/M033/index.md) install territory)

Different domain (install-claude-code.sh, not wiki tooling). Filed as
separate brief: [`.orchestrator/proposals/install-template-preserve-operator-keys.md`](../proposals/install-template-preserve-operator-keys.md).

### Always-skip [`knowledge/index.md`](../knowledge/index.md)
...
sweep; will re-baseline at [M035](../milestones/M035/index.md) packaging.
