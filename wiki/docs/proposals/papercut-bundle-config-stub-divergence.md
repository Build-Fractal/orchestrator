---
title: "Paper-Cut: `packaging/bundle/config/orchestrator.default.yml` is a hand-authored 12-line stub, not a copy/symlink of `templates/orchestrator-config-default.yml`"
---
